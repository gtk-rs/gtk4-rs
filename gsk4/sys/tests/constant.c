...
int main() {
    PRINT_CONSTANT((gint) GSK_ARITHMETIC_NODE);
    ...
    PRINT_CONSTANT((gint) GSK_COMPONENT_TRANSFER_NODE);
    PRINT_CONSTANT((gint) GSK_COMPOSITE_NODE);
    PRINT_CONSTANT((gint) GSK_CONIC_GRADIENT_NODE);
    PRINT_CONSTANT((gint) GSK_CONTAINER_NODE);
    PRINT_CONSTANT((gint) GSK_COPY_NODE);
    ...
    PRINT_CONSTANT((gint) GSK_DISPLACEMENT_NODE);
    ...
    PRINT_CONSTANT((gint) GSK_PASTE_NODE);
    ...
    PRINT_CONSTANT((gint) GSK_PORTER_DUFF_CLEAR);
    PRINT_CONSTANT((gint) GSK_PORTER_DUFF_DEST);
    ...
    PRINT_CONSTANT((gint) GSK_PORTER_DUFF_DEST_OVER_SOURCE);
    PRINT_CONSTANT((gint) GSK_PORTER_DUFF_SOURCE);
    PRINT_CONSTANT((gint) GSK_PORTER_DUFF_SOURCE_ATOP_DEST);
    PRINT_CONSTANT((gint) GSK_PORTER_DUFF_SOURCE_IN_DEST);
    PRINT_CONSTANT((gint) GSK_PORTER_DUFF_SOURCE_OUT_DEST);
    PRINT_CONSTANT((gint) GSK_PORTER_DUFF_SOURCE_OVER_DEST);
    PRINT_CONSTANT((gint) GSK_PORTER_DUFF_XOR);
    PRINT_CONSTANT((gint) GSK_RADIAL_GRADIENT_NODE);
    PRINT_CONSTANT(GSK_RECT_SNAP_GROW);
    PRINT_CONSTANT(GSK_RECT_SNAP_NONE);
    PRINT_CONSTANT(GSK_RECT_SNAP_ROUND);
    PRINT_CONSTANT(GSK_RECT_SNAP_SHRINK);
    ...
    PRINT_CONSTANT((gint) GSK_SIDE_BOTTOM);
    PRINT_CONSTANT((gint) GSK_SIDE_LEFT);
    PRINT_CONSTANT((gint) GSK_SIDE_RIGHT);
    PRINT_CONSTANT((gint) GSK_SIDE_TOP);
    PRINT_CONSTANT((gint) GSK_SNAP_CEIL);
    PRINT_CONSTANT((gint) GSK_SNAP_FLOOR);
    PRINT_CONSTANT((gint) GSK_SNAP_NONE);
    PRINT_CONSTANT((gint) GSK_SNAP_ROUND);
    ...
    PRINT_CONSTANT((gint) GSK_TURBULENCE_NODE);
    return 0;
}
