...
impl IntoGlib for MemoryFormat {
    ...
    fn into_glib(self) -> ffi::GdkMemoryFormat {
        match self {
            ...
            #[cfg(feature = "v4_20")]
            Self::G16B16R1R420 => ffi::GDK_MEMORY_G16_B16_R16_420,
            #[cfg(feature = "v4_20")]
            Self::G16B16R1R422 => ffi::GDK_MEMORY_G16_B16_R16_422,
            #[cfg(feature = "v4_20")]
            Self::G16B16R1R444 => ffi::GDK_MEMORY_G16_B16_R16_444,
            Self::__Unknown(value) => value,
        }
    }
}
...
impl FromGlib<ffi::GdkMemoryFormat> for MemoryFormat {
    unsafe fn from_glib(value: ffi::GdkMemoryFormat) -> Self {
        ...
        match value {
            ...
            #[cfg(feature = "v4_20")]
            ffi::GDK_MEMORY_G16_B16_R16_420 => Self::G16B16R1R420,
            #[cfg(feature = "v4_20")]
            ffi::GDK_MEMORY_G16_B16_R16_422 => Self::G16B16R1R422,
            #[cfg(feature = "v4_20")]
            ffi::GDK_MEMORY_G16_B16_R16_444 => Self::G16B16R1R444,
            value => Self::__Unknown(value),
        }
    }
}
