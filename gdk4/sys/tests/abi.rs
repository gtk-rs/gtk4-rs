...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ...
    ("(guint) GDK_TOPLEVEL_STATE_ABOVE", "32"),
    ("(guint) GDK_TOPLEVEL_STATE_BELOW", "64"),
    ("(guint) GDK_TOPLEVEL_STATE_BOTTOM_RESIZABLE", "16384"),
    ("(guint) GDK_TOPLEVEL_STATE_BOTTOM_TILED", "8192"),
    ("(guint) GDK_TOPLEVEL_STATE_FOCUSED", "128"),
    ("(guint) GDK_TOPLEVEL_STATE_FULLSCREEN", "16"),
    ("(guint) GDK_TOPLEVEL_STATE_LEFT_RESIZABLE", "65536"),
    ("(guint) GDK_TOPLEVEL_STATE_LEFT_TILED", "32768"),
    ("(guint) GDK_TOPLEVEL_STATE_MAXIMIZED", "4"),
    ("(guint) GDK_TOPLEVEL_STATE_MINIMIZED", "2"),
    ("(guint) GDK_TOPLEVEL_STATE_RIGHT_RESIZABLE", "4096"),
    ("(guint) GDK_TOPLEVEL_STATE_RIGHT_TILED", "2048"),
    ("(guint) GDK_TOPLEVEL_STATE_STICKY", "8"),
    ("(guint) GDK_TOPLEVEL_STATE_TILED", "256"),
    ("(guint) GDK_TOPLEVEL_STATE_TOP_RESIZABLE", "1024"),
    ("(guint) GDK_TOPLEVEL_STATE_TOP_TILED", "512"),
    ("(guint) GDK_TOPLEVEL_STATE_WITHDRAWN", "1"),
