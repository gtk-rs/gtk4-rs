...
int main() {
    ...
    PRINT_CONSTANT((gint) GDK_COLOR_CHANNEL_ALPHA);
    PRINT_CONSTANT((gint) GDK_COLOR_CHANNEL_BLUE);
    PRINT_CONSTANT((gint) GDK_COLOR_CHANNEL_GREEN);
    PRINT_CONSTANT((gint) GDK_COLOR_CHANNEL_RED);
    ...
    PRINT_CONSTANT((gint) GDK_DMABUF_ERROR_CREATION_FAILED);
    PRINT_CONSTANT((gint) GDK_DMABUF_ERROR_NOT_AVAILABLE);
    PRINT_CONSTANT((gint) GDK_DMABUF_ERROR_UNSUPPORTED_FORMAT);
    ...
    PRINT_CONSTANT((gint) GDK_FRAME_DISCARDED);
    PRINT_CONSTANT((gint) GDK_FRAME_EMPTY);
    PRINT_CONSTANT((gint) GDK_FRAME_OUTSTANDING);
    PRINT_CONSTANT((gint) GDK_FRAME_PREPARING);
    PRINT_CONSTANT((gint) GDK_FRAME_PRESENTED);
    PRINT_CONSTANT((gint) GDK_FRAME_SKIPPED);
    PRINT_CONSTANT((gint) GDK_FRAME_SUBMITTED);
    ...
    PRINT_CONSTANT(GDK_KEY_10ChannelsDown);
    PRINT_CONSTANT(GDK_KEY_10ChannelsUp);
    ...
    PRINT_CONSTANT(GDK_KEY_ALSToggle);
    ...
    PRINT_CONSTANT(GDK_KEY_Accessibility);
    ...
    PRINT_CONSTANT(GDK_KEY_Addressbook);
    ...
    PRINT_CONSTANT(GDK_KEY_AppSelect);
    ...
    PRINT_CONSTANT(GDK_KEY_Armenian_za);
    PRINT_CONSTANT(GDK_KEY_Armenian_zhe);
    PRINT_CONSTANT(GDK_KEY_AspectRatio);
    PRINT_CONSTANT(GDK_KEY_Assistant);
    PRINT_CONSTANT(GDK_KEY_Atilde);
    PRINT_CONSTANT(GDK_KEY_AttendantOff);
    PRINT_CONSTANT(GDK_KEY_AttendantOn);
    PRINT_CONSTANT(GDK_KEY_AttendantToggle);
    PRINT_CONSTANT(GDK_KEY_AudibleBell_Enable);
    PRINT_CONSTANT(GDK_KEY_Audio);
    PRINT_CONSTANT(GDK_KEY_AudioCycleTrack);
    PRINT_CONSTANT(GDK_KEY_AudioDesc);
    ...
    PRINT_CONSTANT(GDK_KEY_AutopilotEngageToggle);
    ...
    PRINT_CONSTANT(GDK_KEY_BrightnessAuto);
    PRINT_CONSTANT(GDK_KEY_BrightnessMax);
    PRINT_CONSTANT(GDK_KEY_BrightnessMin);
    PRINT_CONSTANT(GDK_KEY_Buttonconfig);
    ...
    PRINT_CONSTANT(GDK_KEY_CameraAccessDisable);
    PRINT_CONSTANT(GDK_KEY_CameraAccessEnable);
    PRINT_CONSTANT(GDK_KEY_CameraAccessToggle);
    PRINT_CONSTANT(GDK_KEY_CameraDown);
    PRINT_CONSTANT(GDK_KEY_CameraFocus);
    PRINT_CONSTANT(GDK_KEY_CameraLeft);
    PRINT_CONSTANT(GDK_KEY_CameraRight);
    PRINT_CONSTANT(GDK_KEY_CameraUp);
    PRINT_CONSTANT(GDK_KEY_CameraZoomIn);
    PRINT_CONSTANT(GDK_KEY_CameraZoomOut);
    ...
    PRINT_CONSTANT(GDK_KEY_Ch);
    PRINT_CONSTANT(GDK_KEY_ChannelDown);
    PRINT_CONSTANT(GDK_KEY_ChannelUp);
    PRINT_CONSTANT(GDK_KEY_Clear);
    PRINT_CONSTANT(GDK_KEY_ClearGrab);
    PRINT_CONSTANT(GDK_KEY_ClearvuSonar);
    ...
    PRINT_CONSTANT(GDK_KEY_ContextMenu);
    PRINT_CONSTANT(GDK_KEY_ContrastAdjust);
    PRINT_CONSTANT(GDK_KEY_ControlPanel);
    ...
    PRINT_CONSTANT(GDK_KEY_DVD);
    PRINT_CONSTANT(GDK_KEY_Dabovedot);
    PRINT_CONSTANT(GDK_KEY_Data);
    PRINT_CONSTANT(GDK_KEY_Database);
    PRINT_CONSTANT(GDK_KEY_Dcaron);
    PRINT_CONSTANT(GDK_KEY_Delete);
    PRINT_CONSTANT(GDK_KEY_Dictate);
    PRINT_CONSTANT(GDK_KEY_Display);
    PRINT_CONSTANT(GDK_KEY_DisplayOff);
    PRINT_CONSTANT(GDK_KEY_DisplayToggle);
    PRINT_CONSTANT(GDK_KEY_DoNotDisturb);
    PRINT_CONSTANT(GDK_KEY_Documents);
    PRINT_CONSTANT(GDK_KEY_DongSign);
    PRINT_CONSTANT(GDK_KEY_Down);
    PRINT_CONSTANT(GDK_KEY_Dstroke);
    PRINT_CONSTANT(GDK_KEY_DualRangeRadar);
    ...
    PRINT_CONSTANT(GDK_KEY_EmojiPicker);
    ...
    PRINT_CONSTANT(GDK_KEY_FastReverse);
    ...
    PRINT_CONSTANT(GDK_KEY_FishingChart);
    PRINT_CONSTANT(GDK_KEY_Fn);
    PRINT_CONSTANT(GDK_KEY_FnRightShift);
    PRINT_CONSTANT(GDK_KEY_Fn_Esc);
    PRINT_CONSTANT(GDK_KEY_Forward);
    PRINT_CONSTANT(GDK_KEY_FrameBack);
    PRINT_CONSTANT(GDK_KEY_FrameForward);
    PRINT_CONSTANT(GDK_KEY_FullScreen);
    ...
    PRINT_CONSTANT(GDK_KEY_GraphicsEditor);
    ...
    PRINT_CONSTANT(GDK_KEY_HangupPhone);
    ...
    PRINT_CONSTANT(GDK_KEY_Images);
    PRINT_CONSTANT(GDK_KEY_Info);
    ...
    PRINT_CONSTANT(GDK_KEY_Journal);
    ...
    PRINT_CONSTANT(GDK_KEY_KbdInputAssistAccept);
    PRINT_CONSTANT(GDK_KEY_KbdInputAssistCancel);
    PRINT_CONSTANT(GDK_KEY_KbdInputAssistNext);
    PRINT_CONSTANT(GDK_KEY_KbdInputAssistNextgroup);
    PRINT_CONSTANT(GDK_KEY_KbdInputAssistPrev);
    PRINT_CONSTANT(GDK_KEY_KbdInputAssistPrevgroup);
    PRINT_CONSTANT(GDK_KEY_KbdLcdMenu1);
    PRINT_CONSTANT(GDK_KEY_KbdLcdMenu2);
    PRINT_CONSTANT(GDK_KEY_KbdLcdMenu3);
    PRINT_CONSTANT(GDK_KEY_KbdLcdMenu4);
    PRINT_CONSTANT(GDK_KEY_KbdLcdMenu5);
    ...
    PRINT_CONSTANT(GDK_KEY_LeftDown);
    PRINT_CONSTANT(GDK_KEY_LeftUp);
    PRINT_CONSTANT(GDK_KEY_LightBulb);
    PRINT_CONSTANT(GDK_KEY_LightsToggle);
    ...
    PRINT_CONSTANT(GDK_KEY_Macedonia_gje);
    PRINT_CONSTANT(GDK_KEY_Macedonia_kje);
    PRINT_CONSTANT(GDK_KEY_Macro1);
    PRINT_CONSTANT(GDK_KEY_Macro10);
    PRINT_CONSTANT(GDK_KEY_Macro11);
    PRINT_CONSTANT(GDK_KEY_Macro12);
    PRINT_CONSTANT(GDK_KEY_Macro13);
    PRINT_CONSTANT(GDK_KEY_Macro14);
    PRINT_CONSTANT(GDK_KEY_Macro15);
    PRINT_CONSTANT(GDK_KEY_Macro16);
    PRINT_CONSTANT(GDK_KEY_Macro17);
    PRINT_CONSTANT(GDK_KEY_Macro18);
    PRINT_CONSTANT(GDK_KEY_Macro19);
    PRINT_CONSTANT(GDK_KEY_Macro2);
    PRINT_CONSTANT(GDK_KEY_Macro20);
    PRINT_CONSTANT(GDK_KEY_Macro21);
    PRINT_CONSTANT(GDK_KEY_Macro22);
    PRINT_CONSTANT(GDK_KEY_Macro23);
    PRINT_CONSTANT(GDK_KEY_Macro24);
    PRINT_CONSTANT(GDK_KEY_Macro25);
    PRINT_CONSTANT(GDK_KEY_Macro26);
    PRINT_CONSTANT(GDK_KEY_Macro27);
    PRINT_CONSTANT(GDK_KEY_Macro28);
    PRINT_CONSTANT(GDK_KEY_Macro29);
    PRINT_CONSTANT(GDK_KEY_Macro3);
    PRINT_CONSTANT(GDK_KEY_Macro30);
    PRINT_CONSTANT(GDK_KEY_Macro4);
    PRINT_CONSTANT(GDK_KEY_Macro5);
    PRINT_CONSTANT(GDK_KEY_Macro6);
    PRINT_CONSTANT(GDK_KEY_Macro7);
    PRINT_CONSTANT(GDK_KEY_Macro8);
    PRINT_CONSTANT(GDK_KEY_Macro9);
    PRINT_CONSTANT(GDK_KEY_MacroPreset1);
    PRINT_CONSTANT(GDK_KEY_MacroPreset2);
    PRINT_CONSTANT(GDK_KEY_MacroPreset3);
    PRINT_CONSTANT(GDK_KEY_MacroPresetCycle);
    PRINT_CONSTANT(GDK_KEY_MacroRecordStart);
    PRINT_CONSTANT(GDK_KEY_MacroRecordStop);
    PRINT_CONSTANT(GDK_KEY_Mae_Koho);
    PRINT_CONSTANT(GDK_KEY_Mail);
    PRINT_CONSTANT(GDK_KEY_MailForward);
    PRINT_CONSTANT(GDK_KEY_MarkWaypoint);
    PRINT_CONSTANT(GDK_KEY_Market);
    PRINT_CONSTANT(GDK_KEY_Massyo);
    PRINT_CONSTANT(GDK_KEY_MediaRepeat);
    PRINT_CONSTANT(GDK_KEY_MediaTopMenu);
    ...
    PRINT_CONSTANT(GDK_KEY_MonBrightnessCycle);
    ...
    PRINT_CONSTANT(GDK_KEY_NavChart);
    PRINT_CONSTANT(GDK_KEY_NavInfo);
    ...
    PRINT_CONSTANT(GDK_KEY_NextElement);
    PRINT_CONSTANT(GDK_KEY_NextFavorite);
    ...
    PRINT_CONSTANT(GDK_KEY_Numeric0);
    PRINT_CONSTANT(GDK_KEY_Numeric1);
    PRINT_CONSTANT(GDK_KEY_Numeric11);
    PRINT_CONSTANT(GDK_KEY_Numeric12);
    PRINT_CONSTANT(GDK_KEY_Numeric2);
    PRINT_CONSTANT(GDK_KEY_Numeric3);
    PRINT_CONSTANT(GDK_KEY_Numeric4);
    PRINT_CONSTANT(GDK_KEY_Numeric5);
    PRINT_CONSTANT(GDK_KEY_Numeric6);
    PRINT_CONSTANT(GDK_KEY_Numeric7);
    PRINT_CONSTANT(GDK_KEY_Numeric8);
    PRINT_CONSTANT(GDK_KEY_Numeric9);
    PRINT_CONSTANT(GDK_KEY_NumericA);
    PRINT_CONSTANT(GDK_KEY_NumericB);
    PRINT_CONSTANT(GDK_KEY_NumericC);
    PRINT_CONSTANT(GDK_KEY_NumericD);
    PRINT_CONSTANT(GDK_KEY_NumericPound);
    PRINT_CONSTANT(GDK_KEY_NumericStar);
    ...
    PRINT_CONSTANT(GDK_KEY_OnScreenKeyboard);
    ...
    PRINT_CONSTANT(GDK_KEY_PauseRecord);
    PRINT_CONSTANT(GDK_KEY_PesetaSign);
    PRINT_CONSTANT(GDK_KEY_Phone);
    PRINT_CONSTANT(GDK_KEY_PickupPhone);
    ...
    PRINT_CONSTANT(GDK_KEY_RadarOverlay);
    ...
    PRINT_CONSTANT(GDK_KEY_RefreshRateToggle);
    ...
    PRINT_CONSTANT(GDK_KEY_RightDown);
    PRINT_CONSTANT(GDK_KEY_RightUp);
    ...
    PRINT_CONSTANT(GDK_KEY_RootMenu);
    PRINT_CONSTANT(GDK_KEY_RotateWindows);
    PRINT_CONSTANT(GDK_KEY_RotationKB);
    PRINT_CONSTANT(GDK_KEY_RotationLockToggle);
    ...
    PRINT_CONSTANT(GDK_KEY_SidevuSonar);
    PRINT_CONSTANT(GDK_KEY_SingleCandidate);
    PRINT_CONSTANT(GDK_KEY_SingleRangeRadar);
    ...
    PRINT_CONSTANT(GDK_KEY_SlowReverse);
    PRINT_CONSTANT(GDK_KEY_Sos);
    PRINT_CONSTANT(GDK_KEY_Spell);
    PRINT_CONSTANT(GDK_KEY_SpellCheck);
    ...
    PRINT_CONSTANT(GDK_KEY_StopRecord);
    ...
    PRINT_CONSTANT(GDK_KEY_Taskmanager);
    ...
    PRINT_CONSTANT(GDK_KEY_TraditionalSonar);
    ...
    PRINT_CONSTANT(GDK_KEY_ZoomReset);
    ...
    PRINT_CONSTANT((gint) GDK_MEMORY_A8B8G8R8_PREMULTIPLIED);
    PRINT_CONSTANT((gint) GDK_MEMORY_A8R8G8B8);
    PRINT_CONSTANT((gint) GDK_MEMORY_A8R8G8B8_PREMULTIPLIED);
    PRINT_CONSTANT((gint) GDK_MEMORY_ABGR2101010);
    PRINT_CONSTANT((gint) GDK_MEMORY_ABGR2101010_PREMULTIPLIED);
    PRINT_CONSTANT((gint) GDK_MEMORY_ARGB2101010);
    PRINT_CONSTANT((gint) GDK_MEMORY_ARGB2101010_PREMULTIPLIED);
    ...
    PRINT_CONSTANT((gint) GDK_MEMORY_B8G8R8G8_422);
    PRINT_CONSTANT((gint) GDK_MEMORY_B8G8R8X8);
    PRINT_CONSTANT((gint) GDK_MEMORY_G10X6_B10X6R10X6_420);
    PRINT_CONSTANT((gint) GDK_MEMORY_G12X4_B12X4R12X4_420);
    PRINT_CONSTANT((gint) GDK_MEMORY_G16);
    ...
    PRINT_CONSTANT((gint) GDK_MEMORY_G8B8G8R8_422);
    PRINT_CONSTANT((gint) GDK_MEMORY_G8R8G8B8_422);
    PRINT_CONSTANT((gint) GDK_MEMORY_G8_B8R8_420);
    PRINT_CONSTANT((gint) GDK_MEMORY_G8_B8R8_422);
    PRINT_CONSTANT((gint) GDK_MEMORY_G8_B8R8_444);
    PRINT_CONSTANT((gint) GDK_MEMORY_G8_B8_R8_410);
    PRINT_CONSTANT((gint) GDK_MEMORY_G8_B8_R8_411);
    PRINT_CONSTANT((gint) GDK_MEMORY_G8_B8_R8_420);
    PRINT_CONSTANT((gint) GDK_MEMORY_G8_B8_R8_422);
    PRINT_CONSTANT((gint) GDK_MEMORY_G8_B8_R8_444);
    PRINT_CONSTANT((gint) GDK_MEMORY_G8_R8B8_420);
    PRINT_CONSTANT((gint) GDK_MEMORY_G8_R8B8_422);
    PRINT_CONSTANT((gint) GDK_MEMORY_G8_R8B8_444);
    PRINT_CONSTANT((gint) GDK_MEMORY_G8_R8_B8_410);
    PRINT_CONSTANT((gint) GDK_MEMORY_G8_R8_B8_411);
    PRINT_CONSTANT((gint) GDK_MEMORY_G8_R8_B8_420);
    PRINT_CONSTANT((gint) GDK_MEMORY_G8_R8_B8_422);
    PRINT_CONSTANT((gint) GDK_MEMORY_G8_R8_B8_444);
    ...
    PRINT_CONSTANT((gint) GDK_MEMORY_XBGR2101010);
    PRINT_CONSTANT((gint) GDK_MEMORY_XRGB2101010);
    ...
    PRINT_CONSTANT((gint) GDK_SCROLL_RELATIVE_DIRECTION_IDENTICAL);
    PRINT_CONSTANT((gint) GDK_SCROLL_RELATIVE_DIRECTION_INVERTED);
    PRINT_CONSTANT((gint) GDK_SCROLL_RELATIVE_DIRECTION_UNKNOWN);
    ...
    PRINT_CONSTANT((guint) GDK_TOPLEVEL_CAPABILITIES_EDGE_CONSTRAINTS);
    PRINT_CONSTANT((guint) GDK_TOPLEVEL_CAPABILITIES_FULLSCREEN);
    PRINT_CONSTANT((guint) GDK_TOPLEVEL_CAPABILITIES_INHIBIT_SHORTCUTS);
    PRINT_CONSTANT((guint) GDK_TOPLEVEL_CAPABILITIES_LOWER);
    PRINT_CONSTANT((guint) GDK_TOPLEVEL_CAPABILITIES_MAXIMIZE);
    PRINT_CONSTANT((guint) GDK_TOPLEVEL_CAPABILITIES_MINIMIZE);
    PRINT_CONSTANT((guint) GDK_TOPLEVEL_CAPABILITIES_TITLEBAR_GESTURES);
    PRINT_CONSTANT((guint) GDK_TOPLEVEL_CAPABILITIES_WINDOW_MENU);
