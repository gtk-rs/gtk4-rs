...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    ...
    (
        "GdkAtom",
        Layout {
            size: size_of::<GdkAtom>(),
            alignment: align_of::<GdkAtom>(),
        },
    ),
    (
        "GdkAxisFlags",
    ...
    (
        "GdkSurfaceClass",
        Layout {
            size: size_of::<GdkSurfaceClass>(),
            alignment: align_of::<GdkSurfaceClass>(),
        },
    ),
    (
        "GdkSurfaceEdge",
    ...
    (
        "GdkSurfaceHints",
        Layout {
            size: size_of::<GdkSurfaceHints>(),
            alignment: align_of::<GdkSurfaceHints>(),
        },
    ),
    (
        "GdkSurfaceState",
        Layout {
            size: size_of::<GdkSurfaceState>(),
            alignment: align_of::<GdkSurfaceState>(),
        },
    ),
    (
        "GdkSurfaceType",
        Layout {
            size: size_of::<GdkSurfaceType>(),
            alignment: align_of::<GdkSurfaceType>(),
        },
    ),
    (
        "GdkSurfaceTypeHint",
        Layout {
            size: size_of::<GdkSurfaceTypeHint>(),
            alignment: align_of::<GdkSurfaceTypeHint>(),
        },
    ),
    (
        "GdkTimeCoord",
...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ...
    ("(gint) GDK_DRAG_ENTER", "14"),
    ("(gint) GDK_DRAG_LEAVE", "15"),
    ("(gint) GDK_DRAG_MOTION", "16"),
    ("(gint) GDK_DROP_START", "17"),
    ("(gint) GDK_ENTER_NOTIFY", "8"),
    ("(guint) GDK_ENTER_NOTIFY_MASK", "4096"),
    ("(gint) GDK_EVENT_LAST", "31"),
    ("GDK_EVENT_PROPAGATE", "0"),
    ("GDK_EVENT_STOP", "1"),
    ("(guint) GDK_EXPOSURE_MASK", "2"),
    ("(gint) GDK_FOCUS_CHANGE", "10"),
    ...
    ("(gint) GDK_LEAVE_NOTIFY", "9"),
    ("(guint) GDK_LEAVE_NOTIFY_MASK", "8192"),
    ("(guint) GDK_LOCK_MASK", "2"),
    ("(gint) GDK_LSB_FIRST", "0"),
    ("GDK_MAX_TIMECOORD_AXES", "128"),
    ("(gint) GDK_MEMORY_A8B8G8R8", "5"),
    ("(gint) GDK_MEMORY_A8R8G8B8", "3"),
    ("(gint) GDK_MEMORY_A8R8G8B8_PREMULTIPLIED", "1"),
    ("(gint) GDK_MEMORY_B8G8R8", "7"),
    ("(gint) GDK_MEMORY_B8G8R8A8", "2"),
    ("(gint) GDK_MEMORY_B8G8R8A8_PREMULTIPLIED", "0"),
    ("(gint) GDK_MEMORY_N_FORMATS", "8"),
    ("(gint) GDK_MEMORY_R8G8B8", "6"),
    ("(gint) GDK_MEMORY_R8G8B8A8", "4"),
    ...
    ("(gint) GDK_OWNERSHIP_SURFACE", "1"),
    ("(gint) GDK_PAD_BUTTON_PRESS", "26"),
    ("(gint) GDK_PAD_BUTTON_RELEASE", "27"),
    ("(gint) GDK_PAD_GROUP_MODE", "30"),
    ("(gint) GDK_PAD_RING", "28"),
    ("(gint) GDK_PAD_STRIP", "29"),
    ...
    ("(gint) GDK_PROXIMITY_IN", "12"),
    ("(guint) GDK_PROXIMITY_IN_MASK", "262144"),
    ("(gint) GDK_PROXIMITY_OUT", "13"),
    ...
    ("(guint) GDK_SURFACE_STATE_ABOVE", "32"),
    ("(guint) GDK_SURFACE_STATE_BELOW", "64"),
    ("(guint) GDK_SURFACE_STATE_BOTTOM_RESIZABLE", "16384"),
    ("(guint) GDK_SURFACE_STATE_BOTTOM_TILED", "8192"),
    ("(guint) GDK_SURFACE_STATE_FOCUSED", "128"),
    ("(guint) GDK_SURFACE_STATE_FULLSCREEN", "16"),
    ("(guint) GDK_SURFACE_STATE_ICONIFIED", "2"),
    ("(guint) GDK_SURFACE_STATE_LEFT_RESIZABLE", "65536"),
    ("(guint) GDK_SURFACE_STATE_LEFT_TILED", "32768"),
    ("(guint) GDK_SURFACE_STATE_MAXIMIZED", "4"),
    ("(guint) GDK_SURFACE_STATE_RIGHT_RESIZABLE", "4096"),
    ("(guint) GDK_SURFACE_STATE_RIGHT_TILED", "2048"),
    ("(guint) GDK_SURFACE_STATE_STICKY", "8"),
    ("(guint) GDK_SURFACE_STATE_TILED", "256"),
    ("(guint) GDK_SURFACE_STATE_TOP_RESIZABLE", "1024"),
    ("(guint) GDK_SURFACE_STATE_TOP_TILED", "512"),
    ("(guint) GDK_SURFACE_STATE_WITHDRAWN", "1"),
    ("(gint) GDK_SURFACE_TEMP", "2"),
    ("(gint) GDK_SURFACE_TOPLEVEL", "0"),
    ("(gint) GDK_SURFACE_TYPE_HINT_COMBO", "12"),
    ("(gint) GDK_SURFACE_TYPE_HINT_DESKTOP", "7"),
    ("(gint) GDK_SURFACE_TYPE_HINT_DIALOG", "1"),
    ("(gint) GDK_SURFACE_TYPE_HINT_DND", "13"),
    ("(gint) GDK_SURFACE_TYPE_HINT_DOCK", "6"),
    ("(gint) GDK_SURFACE_TYPE_HINT_DROPDOWN_MENU", "8"),
    ("(gint) GDK_SURFACE_TYPE_HINT_MENU", "2"),
    ("(gint) GDK_SURFACE_TYPE_HINT_NORMAL", "0"),
    ("(gint) GDK_SURFACE_TYPE_HINT_NOTIFICATION", "11"),
    ("(gint) GDK_SURFACE_TYPE_HINT_POPUP_MENU", "9"),
    ("(gint) GDK_SURFACE_TYPE_HINT_SPLASHSCREEN", "4"),
    ("(gint) GDK_SURFACE_TYPE_HINT_TOOLBAR", "3"),
    ("(gint) GDK_SURFACE_TYPE_HINT_TOOLTIP", "10"),
    ("(gint) GDK_SURFACE_TYPE_HINT_UTILITY", "5"),
    ...
    ("(gint) GDK_TOUCHPAD_PINCH", "25"),
    ("(gint) GDK_TOUCHPAD_SWIPE", "24"),
    ("(gint) GDK_TOUCH_BEGIN", "20"),
    ("(gint) GDK_TOUCH_CANCEL", "23"),
    ("(gint) GDK_TOUCH_END", "22"),
    ("(guint) GDK_TOUCH_MASK", "4194304"),
    ("(gint) GDK_TOUCH_UPDATE", "21"),
