...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ...
    ("(gint) GDK_DRAG_ENTER", "12"),
    ("(gint) GDK_DRAG_LEAVE", "13"),
    ("(gint) GDK_DRAG_MOTION", "14"),
    ("(gint) GDK_DROP_START", "15"),
    ...
    ("(guint) GDK_MODIFIER_MASK", "469770239"),
    ...
    ("(guint) GDK_MODIFIER_RESERVED_30_MASK", "1073741824"),
    ...
    ("(gint) GDK_PAD_BUTTON_PRESS", "24"),
    ("(gint) GDK_PAD_BUTTON_RELEASE", "25"),
    ("(gint) GDK_PAD_GROUP_MODE", "28"),
    ("(gint) GDK_PAD_RING", "26"),
    ("(gint) GDK_PAD_STRIP", "27"),
    ...
    ("(gint) GDK_PROXIMITY_IN", "10"),
    ("(guint) GDK_PROXIMITY_IN_MASK", "262144"),
    ("(gint) GDK_PROXIMITY_OUT", "11"),
    ...
    ("(guint) GDK_SURFACE_STATE_MINIMIZED", "2"),
    ...
    ("(gint) GDK_TOUCHPAD_PINCH", "23"),
    ("(gint) GDK_TOUCHPAD_SWIPE", "22"),
    ("(gint) GDK_TOUCH_BEGIN", "18"),
    ("(gint) GDK_TOUCH_CANCEL", "21"),
    ("(gint) GDK_TOUCH_END", "20"),
    ("(guint) GDK_TOUCH_MASK", "4194304"),
    ("(gint) GDK_TOUCH_UPDATE", "19"),
