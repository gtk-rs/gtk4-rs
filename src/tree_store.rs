...
impl TreeStore {
    pub fn new(column_types: &[Type]) -> TreeStore {
        ...
        unsafe {
            ...
            from_glib_full(
                gtk_sys::gtk_tree_store_newv(column_types.len() as c_int,
...
impl<O: IsA<TreeStore>> TreeStoreExtManual for O {
    fn insert_with_values(
        ...
        unsafe {
            ...
            gtk_sys::gtk_tree_store_insert_with_valuesv(self.as_ref().to_glib_none().0,
    ...
    fn reorder(&self, parent: &TreeIter, new_order: &[u32]) {
        unsafe {
            let count = gtk_sys::gtk_tree_model_iter_n_children(self.as_ref().upcast_ref::<TreeModel>().to_glib_none().0,
                                                            mut_override(parent.to_glib_none().0));
            ...
            if safe_count && safe_values {
                gtk_sys::gtk_tree_store_reorder(self.as_ref().to_glib_none().0,
                                            mut_override(parent.to_glib_none().0),
    ...
    fn set(&self, iter: &TreeIter, columns: &[u32], values: &[&dyn ToValue]) {
        unsafe {
            ...
            gtk_sys::gtk_tree_store_set_valuesv(self.as_ref().to_glib_none().0,
    ...
    fn set_value(&self, iter: &TreeIter, column: u32, value: &Value) {
        unsafe {
            ...
            gtk_sys::gtk_tree_store_set_value(self.as_ref().to_glib_none().0,
