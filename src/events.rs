...
impl NothingEvent {
    pub fn new() -> NothingEvent {
        assert_initialized_main_thread!();
        let event: Event = unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_NOTHING)) };
...
impl DeleteEvent {
    pub fn new() -> DeleteEvent {
        assert_initialized_main_thread!();
        let event: Event = unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_DELETE)) };
        event.try_into().unwrap()
    }
}
...
impl DestroyEvent {
    pub fn new() -> DestroyEvent {
        assert_initialized_main_thread!();
        let event: Event = unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_DESTROY)) };
        event.try_into().unwrap()
    }
}
...
impl MotionNotifyEvent {
    pub fn new() -> MotionNotifyEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_MOTION_NOTIFY)) };
        event.try_into().unwrap()
    }
    ...
    pub fn get_axes(&self) -> Option<Vec<f64>> {
        unsafe {
            ...
            let ret = from_glib(gdk_sys::gdk_event_get_axes(
                self.to_glib_none().0,
                &mut axes,
                n_axes.as_mut_ptr(),
            ));
    ...
    pub fn get_motion_history(&self) -> Vec<TimeCoord> {
        unsafe {
            FromGlibPtrContainer::from_glib_container(gdk_sys::gdk_event_get_motion_history(
                self.to_glib_none().0,
            ))
        }
    }
...
impl ButtonPressEvent {
    ...
    pub fn get_button(&self) -> u32 {
        unsafe {
            ...
            let ret = from_glib(gdk_sys::gdk_event_get_button(
                self.to_glib_none().0,
                button.as_mut_ptr(),
            ));
    ...
    pub fn get_click_count(&self) -> u32 {
        unsafe {
            ...
            let ret = from_glib(gdk_sys::gdk_event_get_click_count(
                self.to_glib_none().0,
                click_count.as_mut_ptr(),
            ));
    ...
    pub fn new() -> ButtonPressEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_BUTTON_PRESS)) };
        event.try_into().unwrap()
    }
}
...
impl ButtonReleaseEvent {
    ...
    pub fn new() -> ButtonReleaseEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_BUTTON_RELEASE)) };
        event.try_into().unwrap()
    }
}
...
impl KeyPressEvent {
    pub fn get_key_group(&self) -> u32 {
        unsafe {
            ...
            let ret = from_glib(gdk_sys::gdk_event_get_key_group(
                self.to_glib_none().0,
                group.as_mut_ptr(),
            ));
    ...
    pub fn get_key_is_modifier(&self) -> bool {
        unsafe {
            ...
            let ret = from_glib(gdk_sys::gdk_event_get_key_is_modifier(
                self.to_glib_none().0,
                is_modifier.as_mut_ptr(),
            ));
            let is_modifier = is_modifier.assume_init();
            if ret {
                Some(from_glib(is_modifier))
            } else {
                None
            }
        }
    ...
    pub fn get_keycode(&self) -> u16 {
        unsafe {
            ...
            let ret = from_glib(gdk_sys::gdk_event_get_keycode(
                self.to_glib_none().0,
                keycode.as_mut_ptr(),
            ));
    ...
    pub fn get_keyval(&self) -> u32 {
        unsafe {
            ...
            let ret = from_glib(gdk_sys::gdk_event_get_keyval(
                self.to_glib_none().0,
                keyval.as_mut_ptr(),
            ));
    ...
    pub fn get_scancode(&self) -> i32 {
        unsafe { gdk_sys::gdk_event_get_scancode(self.to_glib_none().0) }
    }

    pub fn new() -> KeyPressEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_KEY_PRESS)) };
        event.try_into().unwrap()
    }
}
...
impl KeyReleaseEvent {
    ...
    pub fn new() -> KeyReleaseEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_KEY_RELEASE)) };
        event.try_into().unwrap()
    }
}
...
impl EnterNotifyEvent {
    pub fn get_crossing_detail(&self) -> NotifyType {
        unsafe {
            ...
            let ret = from_glib(gdk_sys::gdk_event_get_crossing_detail(
                self.to_glib_none().0,
                detail.as_mut_ptr(),
            ));
            let detail = detail.assume_init();
            if ret {
                Some(from_glib(detail))
            } else {
                None
            }
        }
    ...
    pub fn get_crossing_mode(&self) -> CrossingMode {
        unsafe {
            ...
            let ret = from_glib(gdk_sys::gdk_event_get_crossing_mode(
                self.to_glib_none().0,
                mode.as_mut_ptr(),
            ));
    ...
    pub fn new() -> EnterNotifyEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_ENTER_NOTIFY)) };
        event.try_into().unwrap()
    }
}
...
impl LeaveNotifyEvent {
    ...
    pub fn new() -> LeaveNotifyEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_LEAVE_NOTIFY)) };
        event.try_into().unwrap()
    }
}
...
impl FocusChangeEvent {
    ...
    pub fn get_focus_in(&self) -> bool {
        unsafe {
            ...
            let ret = from_glib(gdk_sys::gdk_event_get_focus_in(
                self.to_glib_none().0,
                focus_in.as_mut_ptr(),
            ));
            let focus_in = focus_in.assume_init();
            if ret {
                Some(from_glib(focus_in))
            } else {
                None
            }
        }
    ...
    pub fn new() -> FocusChangeEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_FOCUS_CHANGE)) };
        event.try_into().unwrap()
    }
}
...
impl ConfigureEvent {
    pub fn new() -> ConfigureEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_CONFIGURE)) };
        event.try_into().unwrap()
    }
}
...
impl ProximityInEvent {
    pub fn new() -> ProximityInEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_PROXIMITY_IN)) };
        event.try_into().unwrap()
    }
}
...
impl ProximityOutEvent {
    pub fn new() -> ProximityOutEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_PROXIMITY_OUT)) };
        event.try_into().unwrap()
    }
}
...
impl DragEnterEvent {
    pub fn get_drop(&self) -> Drop {
        let result: Option<_> =
            unsafe { from_glib_none(gdk_sys::gdk_event_get_drop(self.to_glib_none().0)) };
        result.expect("Event getter failed")
    }
    ...
    pub fn new() -> DragEnterEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_DRAG_ENTER)) };
        event.try_into().unwrap()
    }
}
...
impl DragLeaveEvent {
    ...
    pub fn new() -> DragLeaveEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_DRAG_LEAVE)) };
        event.try_into().unwrap()
    }
}
...
impl DragMotionEvent {
    ...
    pub fn new() -> DragMotionEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_DRAG_MOTION)) };
        event.try_into().unwrap()
    }
}
...
impl DropStartEvent {
    ...
    pub fn new() -> DropStartEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_DROP_START)) };
        event.try_into().unwrap()
    }
}
...
impl ScrollEvent {
    pub fn get_scroll_deltas(&self) -> Option<(f64, f64)> {
        unsafe {
            ...
            let ret = from_glib(gdk_sys::gdk_event_get_scroll_deltas(
                self.to_glib_none().0,
                delta_x.as_mut_ptr(),
                delta_y.as_mut_ptr(),
            ));
    ...
    pub fn get_scroll_direction(&self) -> Option<ScrollDirection> {
        unsafe {
            ...
            let ret = from_glib(gdk_sys::gdk_event_get_scroll_direction(
                self.to_glib_none().0,
    ...
    pub fn new() -> ScrollEvent {
        assert_initialized_main_thread!();
        let event: Event = unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_SCROLL)) };
        event.try_into().unwrap()
    }
}
...
impl GrabBrokenEvent {
    pub fn get_grab_surface(&self) -> Surface {
        unsafe {
            ...
            let ret = from_glib(gdk_sys::gdk_event_get_grab_surface(
                self.to_glib_none().0,
                &mut surface,
            ));
            if ret {
                Some(from_glib_none(surface))
            } else {
                None
            }
        }
    ...
    pub fn new() -> GrabBrokenEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_GRAB_BROKEN)) };
        event.try_into().unwrap()
    }
}
...
impl TouchBeginEvent {
    ...
    pub fn get_touch_emulating_pointer(&self) -> bool {
        unsafe {
            ...
            let ret = from_glib(gdk_sys::gdk_event_get_touch_emulating_pointer(
                self.to_glib_none().0,
                emulating.as_mut_ptr(),
            ));
            let emulating = emulating.assume_init();
            if ret {
                Some(from_glib(emulating))
            } else {
                None
            }
        }
    ...
    pub fn new() -> TouchBeginEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_TOUCH_BEGIN)) };
        event.try_into().unwrap()
    }
}
...
impl TouchUpdateEvent {
    ...
    pub fn new() -> TouchUpdateEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_TOUCH_UPDATE)) };
        event.try_into().unwrap()
    }
}
...
impl TouchEndEvent {
    ...
    pub fn new() -> TouchEndEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_TOUCH_END)) };
        event.try_into().unwrap()
    }
}
...
impl TouchCancelEvent {
    ...
    pub fn new() -> TouchCancelEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_TOUCH_CANCEL)) };
        event.try_into().unwrap()
    }
}
...
impl TouchpadSwipeEvent {
    pub fn get_touchpad_deltas(&self) -> (f64, f64) {
        unsafe {
            ...
            let ret = from_glib(gdk_sys::gdk_event_get_touchpad_deltas(
                self.to_glib_none().0,
                dx.as_mut_ptr(),
                dy.as_mut_ptr(),
            ));
    ...
    pub fn get_touchpad_gesture_n_fingers(&self) -> u32 {
        unsafe {
            ...
            let ret = from_glib(gdk_sys::gdk_event_get_touchpad_gesture_n_fingers(
                self.to_glib_none().0,
                n_fingers.as_mut_ptr(),
            ));
    ...
    pub fn get_touchpad_gesture_phase(&self) -> TouchpadGesturePhase {
        unsafe {
            ...
            let ret = from_glib(gdk_sys::gdk_event_get_touchpad_gesture_phase(
                self.to_glib_none().0,
                phase.as_mut_ptr(),
            ));
            let phase = phase.assume_init();
            if ret {
                Some(from_glib(phase))
            } else {
                None
            }
        }
    ...
    pub fn new() -> TouchpadSwipeEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_TOUCHPAD_SWIPE)) };
        event.try_into().unwrap()
    }
}
...
impl TouchpadPinchEvent {
    pub fn get_touchpad_angle_delta(&self) -> f64 {
        unsafe {
            ...
            let ret = from_glib(gdk_sys::gdk_event_get_touchpad_angle_delta(
                self.to_glib_none().0,
                delta.as_mut_ptr(),
            ));
    ...
    pub fn get_touchpad_scale(&self) -> f64 {
        unsafe {
            ...
            let ret = from_glib(gdk_sys::gdk_event_get_touchpad_scale(
                self.to_glib_none().0,
                scale.as_mut_ptr(),
            ));
    ...
    pub fn new() -> TouchpadPinchEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_TOUCHPAD_PINCH)) };
        event.try_into().unwrap()
    }
}
...
impl PadButtonPressEvent {
    ...
    pub fn get_pad_button(&self) -> u32 {
        unsafe {
            let mut button = mem::MaybeUninit::uninit();
            let ret = from_glib(gdk_sys::gdk_event_get_pad_button(
                self.to_glib_none().0,
                button.as_mut_ptr(),
            ));
            let button = button.assume_init();
    ...
    pub fn get_pad_group_mode(&self) -> (u32, u32) {
        unsafe {
            let mut group = mem::MaybeUninit::uninit();
            let mut mode = mem::MaybeUninit::uninit();
            let ret = from_glib(gdk_sys::gdk_event_get_pad_group_mode(
                self.to_glib_none().0,
                group.as_mut_ptr(),
                mode.as_mut_ptr(),
            ));
    ...
    pub fn new() -> PadButtonPressEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_PAD_BUTTON_PRESS)) };
        event.try_into().unwrap()
    }
}
...
impl PadButtonReleaseEvent {
    ...
    pub fn new() -> PadButtonReleaseEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_PAD_BUTTON_RELEASE)) };
        event.try_into().unwrap()
    }
}
...
impl PadRingEvent {
    pub fn get_pad_axis_value(&self) -> (u32, f64) {
        unsafe {
            ...
            let ret = from_glib(gdk_sys::gdk_event_get_pad_axis_value(
                self.to_glib_none().0,
                index.as_mut_ptr(),
                value.as_mut_ptr(),
            ));
    ...
    pub fn new() -> PadRingEvent {
        assert_initialized_main_thread!();
        let event: Event = unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_PAD_RING)) };
        event.try_into().unwrap()
    }
}
...
impl PadStripEvent {
    ...
    pub fn new() -> PadStripEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_PAD_STRIP)) };
        event.try_into().unwrap()
    }
}
...
impl PadGroupModeEvent {
    ...
    pub fn new() -> PadGroupModeEvent {
        assert_initialized_main_thread!();
        let event: Event =
            unsafe { from_glib_full(gdk_sys::gdk_event_new(gdk_sys::GDK_PAD_GROUP_MODE)) };
        event.try_into().unwrap()
    }
}
