...
impl PageSetup {
    ...
    //    unsafe { TODO: call ffi::gtk_page_setup_new_from_gvariant() }
    //}
    ...
    pub fn set_paper_size(&self, size: &mut PaperSize) {
        unsafe {
            ffi::gtk_page_setup_set_paper_size(self.to_glib_none().0, size.to_glib_none_mut().0);
        }
    }

    pub fn set_paper_size_and_default_margins(&self, size: &mut PaperSize) {
        unsafe {
            ffi::gtk_page_setup_set_paper_size_and_default_margins(self.to_glib_none().0, size.to_glib_none_mut().0);
        }
    }
    ...
    //    unsafe { TODO: call ffi::gtk_page_setup_to_gvariant() }
    //}
