...
impl PictureBuilder {
    ...
    pub fn build(self) -> Picture {
        ...
        glib::Object::new(Picture::static_type(), &properties)
            .expect("object new")
            .downcast()
            .expect("downcast")
    }
    ...
    fn connect_property_alternative_text_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(
                    notify_alternative_text_trampoline::<Self, F> as usize,
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_property_can_shrink_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(notify_can_shrink_trampoline::<Self, F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    fn connect_property_keep_aspect_ratio_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(
                    notify_keep_aspect_ratio_trampoline::<Self, F> as usize,
                )),
                Box_::into_raw(f),
            )
        }
