...
impl<O: IsA<ToolItem>> ToolItemExt for O {
    ...
    fn set_property_expand_item(&self, expand_item: bool) {
        unsafe {
            gobject_sys::g_object_set_property(
                self.to_glib_none().0 as *mut gobject_sys::GObject,
                b"expand-item\0".as_ptr() as *const _,
                Value::from(&expand_item).to_glib_none().0,
            );
        }
    }
    ...
    fn connect_property_expand_item_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_expand_item_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut gtk_sys::GtkToolItem,
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"notify::expand-item\0".as_ptr() as *const _,
                Some(transmute(notify_expand_item_trampoline::<Self, F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
