...
glib_wrapper! {
    pub struct FileChooserButton(Object<gtk_sys::GtkFileChooserButton, FileChooserButtonClass>) @extends Widget, @implements Accessible, Buildable, FileChooser;
...
impl FileChooserButton {
    ...
    pub fn get_modal(&self) -> bool {
        unsafe {
            from_glib(gtk_sys::gtk_file_chooser_button_get_modal(
                self.to_glib_none().0,
            ))
        }
    }
    ...
    pub fn set_modal(&self, modal: bool) {
        unsafe {
            gtk_sys::gtk_file_chooser_button_set_modal(self.to_glib_none().0, modal.to_glib());
        }
    }
    ...
    pub fn connect_property_modal_notify<F: Fn(&FileChooserButton) + 'static>(
        &self,
        f: F,
    ) -> SignalHandlerId {
        unsafe extern "C" fn notify_modal_trampoline<F: Fn(&FileChooserButton) + 'static>(
            this: *mut gtk_sys::GtkFileChooserButton,
