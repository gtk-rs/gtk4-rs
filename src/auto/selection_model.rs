...
glib_wrapper! {
    pub struct SelectionModel(Interface<ffi::GtkSelectionModel>);
...
impl<O: IsA<SelectionModel>> SelectionModelExt for O {
    fn is_selected(&self, position: u32) -> bool {
        unsafe {
            from_glib(ffi::gtk_selection_model_is_selected(self.as_ref().to_glib_none().0, position))
        }
    }
    ...
    fn query_range(&self, position: u32) -> (u32, u32, bool) {
        unsafe {
            ...
            ffi::gtk_selection_model_query_range(self.as_ref().to_glib_none().0, position, &mut start_range, &mut n_items, &mut selected);
    ...
    fn select_all(&self) -> bool {
        unsafe {
            from_glib(ffi::gtk_selection_model_select_all(self.as_ref().to_glib_none().0))
        }
    }

    fn select_item(&self, position: u32, exclusive: bool) -> bool {
        unsafe {
            from_glib(ffi::gtk_selection_model_select_item(self.as_ref().to_glib_none().0, position, exclusive.to_glib()))
        }
    }

    fn select_range(&self, position: u32, n_items: u32, exclusive: bool) -> bool {
        unsafe {
            from_glib(ffi::gtk_selection_model_select_range(self.as_ref().to_glib_none().0, position, n_items, exclusive.to_glib()))
        }
    }

    fn selection_changed(&self, position: u32, n_items: u32) {
        unsafe {
            ffi::gtk_selection_model_selection_changed(self.as_ref().to_glib_none().0, position, n_items);
        }
    }

    fn unselect_all(&self) -> bool {
        unsafe {
            from_glib(ffi::gtk_selection_model_unselect_all(self.as_ref().to_glib_none().0))
        }
    }

    fn unselect_item(&self, position: u32) -> bool {
        unsafe {
            from_glib(ffi::gtk_selection_model_unselect_item(self.as_ref().to_glib_none().0, position))
        }
    }

    fn unselect_range(&self, position: u32, n_items: u32) -> bool {
        unsafe {
            from_glib(ffi::gtk_selection_model_unselect_range(self.as_ref().to_glib_none().0, position, n_items))
        }
    }
...
unsafe extern "C" fn selection_changed_trampoline<P, F: Fn(&P, u32, u32) + 'static>(this: *mut ffi::GtkSelectionModel, position: libc::c_uint, n_items: libc::c_uint, f: glib_ffi::gpointer)
