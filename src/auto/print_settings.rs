...
impl PrintSettings {
    ...
    //    unsafe { TODO: call ffi::gtk_print_settings_new_from_gvariant() }
    //}
    ...
    pub fn set_paper_size(&self, paper_size: &mut PaperSize) {
        unsafe {
            ffi::gtk_print_settings_set_paper_size(self.to_glib_none().0, paper_size.to_glib_none_mut().0);
        }
    }
    ...
    //    unsafe { TODO: call ffi::gtk_print_settings_to_gvariant() }
    //}
