...
impl<O: IsA<TreeModelSort>> TreeModelSortExt for O {
    ...
    fn convert_child_iter_to_iter(&self, child_iter: &mut TreeIter) -> Option<TreeIter> {
        unsafe {
            ...
            let ret = from_glib(ffi::gtk_tree_model_sort_convert_child_iter_to_iter(self.as_ref().to_glib_none().0, sort_iter.to_glib_none_mut().0, child_iter.to_glib_none_mut().0));
    ...
    fn convert_child_path_to_path(&self, child_path: &mut TreePath) -> Option<TreePath> {
        unsafe {
            from_glib_full(ffi::gtk_tree_model_sort_convert_child_path_to_path(self.as_ref().to_glib_none().0, child_path.to_glib_none_mut().0))
        }
    }
    ...
    fn convert_iter_to_child_iter(&self, sorted_iter: &mut TreeIter) -> TreeIter {
        unsafe {
            ...
            ffi::gtk_tree_model_sort_convert_iter_to_child_iter(self.as_ref().to_glib_none().0, child_iter.to_glib_none_mut().0, sorted_iter.to_glib_none_mut().0);
            child_iter
        }
    }
    ...
    fn convert_path_to_child_path(&self, sorted_path: &mut TreePath) -> Option<TreePath> {
        unsafe {
            from_glib_full(ffi::gtk_tree_model_sort_convert_path_to_child_path(self.as_ref().to_glib_none().0, sorted_path.to_glib_none_mut().0))
        }
    }
    ...
    fn iter_is_valid(&self, iter: &mut TreeIter) -> bool {
        unsafe {
            from_glib(ffi::gtk_tree_model_sort_iter_is_valid(self.as_ref().to_glib_none().0, iter.to_glib_none_mut().0))
        }
    }
