...
glib_wrapper! {
    pub struct GLContext(Object<ffi::GdkGLContext, GLContextClass>) @extends DrawContext;
...
impl GLContext {
    ...
    //pub fn realize(&self, error: /*Ignored*/Option<Error>) -> bool {
    //    unsafe { TODO: call ffi::gdk_gl_context_realize() }
    //}
