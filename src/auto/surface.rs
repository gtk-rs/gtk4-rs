...
impl Surface {
    pub fn new_child<P: IsA<Surface>>(parent: &P, position: &Rectangle) -> Surface {
        ...
        unsafe {
            from_glib_full(gdk_sys::gdk_surface_new_child(
    ...
    pub fn new_temp(display: &Display) -> Surface {
        skip_assert_initialized!();
        unsafe { from_glib_full(gdk_sys::gdk_surface_new_temp(display.to_glib_none().0)) }
    }
    ...
    pub fn constrain_size(
        ...
        unsafe {
            ...
            gdk_sys::gdk_surface_constrain_size(
...
impl<O: IsA<Surface>> SurfaceExt for O {
    ...
    fn begin_move_drag(&self, button: i32, x: i32, y: i32, timestamp: u32) {
        unsafe {
            gdk_sys::gdk_surface_begin_move_drag(
    ...
    fn begin_move_drag_for_device(
        ...
        unsafe {
            gdk_sys::gdk_surface_begin_move_drag_for_device(
                self.as_ref().to_glib_none().0,
    ...
    fn begin_resize_drag(&self, edge: SurfaceEdge, button: i32, x: i32, y: i32, timestamp: u32) {
        unsafe {
            gdk_sys::gdk_surface_begin_resize_drag(
                self.as_ref().to_glib_none().0,
                edge.to_glib(),
                button,
                x,
    ...
    fn begin_resize_drag_for_device(
        ...
        unsafe {
            gdk_sys::gdk_surface_begin_resize_drag_for_device(
                self.as_ref().to_glib_none().0,
                edge.to_glib(),
                device.to_glib_none().0,
                button,
    ...
    fn coords_from_parent(&self, parent_x: f64, parent_y: f64) -> (f64, f64) {
        unsafe {
            ...
            gdk_sys::gdk_surface_coords_from_parent(
                self.as_ref().to_glib_none().0,
                parent_x,
                parent_y,
                x.as_mut_ptr(),
    ...
    fn coords_to_parent(&self, x: f64, y: f64) -> (f64, f64) {
        unsafe {
            ...
            gdk_sys::gdk_surface_coords_to_parent(
                self.as_ref().to_glib_none().0,
                x,
                y,
                parent_x.as_mut_ptr(),
    ...
    fn create_gl_context(&self) -> Result<GLContext, glib::Error> {
        unsafe {
            ...
            let ret =
                gdk_sys::gdk_surface_create_gl_context(self.as_ref().to_glib_none().0, &mut error);
            if error.is_null() {
    ...
    fn fullscreen_on_monitor(&self, monitor: &Monitor) {
        unsafe {
            gdk_sys::gdk_surface_fullscreen_on_monitor(
                self.as_ref().to_glib_none().0,
    ...
    fn get_accept_focus(&self) -> bool {
        unsafe {
            from_glib(gdk_sys::gdk_surface_get_accept_focus(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_children(&self) -> Vec<Surface> {
        unsafe {
            FromGlibPtrContainer::from_glib_container(gdk_sys::gdk_surface_get_children(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_cursor(&self) -> Option<Cursor> {
        unsafe {
            from_glib_none(gdk_sys::gdk_surface_get_cursor(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_decorations(&self) -> Option<WMDecoration> {
        unsafe {
            ...
            let ret = from_glib(gdk_sys::gdk_surface_get_decorations(
                self.as_ref().to_glib_none().0,
    ...
    fn get_device_position(&self, device: &Device) -> (Option<Surface>, f64, f64, ModifierType) {
        unsafe {
            ...
            let ret = from_glib_none(gdk_sys::gdk_surface_get_device_position(
                self.as_ref().to_glib_none().0,
                device.to_glib_none().0,
                x.as_mut_ptr(),
                y.as_mut_ptr(),
    ...
    fn get_display(&self) -> Option<Display> {
        unsafe {
            from_glib_none(gdk_sys::gdk_surface_get_display(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_focus_on_map(&self) -> bool {
        unsafe {
            from_glib(gdk_sys::gdk_surface_get_focus_on_map(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_frame_clock(&self) -> Option<FrameClock> {
        unsafe {
            from_glib_none(gdk_sys::gdk_surface_get_frame_clock(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_frame_extents(&self) -> Rectangle {
        unsafe {
            ...
            gdk_sys::gdk_surface_get_frame_extents(
                self.as_ref().to_glib_none().0,
    ...
    fn get_fullscreen_mode(&self) -> FullscreenMode {
        unsafe {
            from_glib(gdk_sys::gdk_surface_get_fullscreen_mode(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_geometry(&self) -> (i32, i32, i32, i32) {
        unsafe {
            ...
            gdk_sys::gdk_surface_get_geometry(
                self.as_ref().to_glib_none().0,
                x.as_mut_ptr(),
                y.as_mut_ptr(),
                width.as_mut_ptr(),
    ...
    fn get_height(&self) -> i32 {
        unsafe { gdk_sys::gdk_surface_get_height(self.as_ref().to_glib_none().0) }
    }

    fn get_modal_hint(&self) -> bool {
        unsafe {
            from_glib(gdk_sys::gdk_surface_get_modal_hint(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_origin(&self) -> (i32, i32, i32) {
        unsafe {
            let mut x = mem::MaybeUninit::uninit();
            let mut y = mem::MaybeUninit::uninit();
            let ret = gdk_sys::gdk_surface_get_origin(
                self.as_ref().to_glib_none().0,
                x.as_mut_ptr(),
                y.as_mut_ptr(),
            );
    ...
    fn get_parent(&self) -> Option<Surface> {
        unsafe {
            from_glib_none(gdk_sys::gdk_surface_get_parent(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_pass_through(&self) -> bool {
        unsafe {
            from_glib(gdk_sys::gdk_surface_get_pass_through(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_position(&self) -> (i32, i32) {
        unsafe {
            let mut x = mem::MaybeUninit::uninit();
            let mut y = mem::MaybeUninit::uninit();
            gdk_sys::gdk_surface_get_position(
                self.as_ref().to_glib_none().0,
                x.as_mut_ptr(),
                y.as_mut_ptr(),
            );
    ...
    fn get_root_coords(&self, x: i32, y: i32) -> (i32, i32) {
        unsafe {
            ...
            gdk_sys::gdk_surface_get_root_coords(
                self.as_ref().to_glib_none().0,
                x,
                y,
                root_x.as_mut_ptr(),
    ...
    fn get_root_origin(&self) -> (i32, i32) {
        unsafe {
            let mut x = mem::MaybeUninit::uninit();
            let mut y = mem::MaybeUninit::uninit();
            gdk_sys::gdk_surface_get_root_origin(
                self.as_ref().to_glib_none().0,
                x.as_mut_ptr(),
                y.as_mut_ptr(),
            );
    ...
    fn get_scale_factor(&self) -> i32 {
        unsafe { gdk_sys::gdk_surface_get_scale_factor(self.as_ref().to_glib_none().0) }
    }

    fn get_state(&self) -> SurfaceState {
        unsafe {
            from_glib(gdk_sys::gdk_surface_get_state(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_support_multidevice(&self) -> bool {
        unsafe {
            from_glib(gdk_sys::gdk_surface_get_support_multidevice(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_surface_type(&self) -> SurfaceType {
        unsafe {
            from_glib(gdk_sys::gdk_surface_get_surface_type(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_toplevel(&self) -> Option<Surface> {
        unsafe {
            from_glib_none(gdk_sys::gdk_surface_get_toplevel(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_type_hint(&self) -> SurfaceTypeHint {
        unsafe {
            from_glib(gdk_sys::gdk_surface_get_type_hint(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_width(&self) -> i32 {
        unsafe { gdk_sys::gdk_surface_get_width(self.as_ref().to_glib_none().0) }
    }

    fn has_native(&self) -> bool {
        unsafe {
            from_glib(gdk_sys::gdk_surface_has_native(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn input_shape_combine_region(
        ...
        unsafe {
            gdk_sys::gdk_surface_input_shape_combine_region(
                self.as_ref().to_glib_none().0,
    ...
    fn is_destroyed(&self) -> bool {
        unsafe {
            from_glib(gdk_sys::gdk_surface_is_destroyed(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn is_input_only(&self) -> bool {
        unsafe {
            from_glib(gdk_sys::gdk_surface_is_input_only(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn is_viewable(&self) -> bool {
        unsafe {
            from_glib(gdk_sys::gdk_surface_is_viewable(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn is_visible(&self) -> bool {
        unsafe {
            from_glib(gdk_sys::gdk_surface_is_visible(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn move_to_rect(
        ...
        unsafe {
            gdk_sys::gdk_surface_move_to_rect(
                self.as_ref().to_glib_none().0,
                rect.to_glib_none().0,
                rect_anchor.to_glib(),
    ...
    fn peek_children(&self) -> Vec<Surface> {
        unsafe {
            FromGlibPtrContainer::from_glib_none(gdk_sys::gdk_surface_peek_children(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn set_accept_focus(&self, accept_focus: bool) {
        unsafe {
            gdk_sys::gdk_surface_set_accept_focus(
                self.as_ref().to_glib_none().0,
    ...
    fn set_cursor(&self, cursor: Option<&Cursor>) {
        unsafe {
            gdk_sys::gdk_surface_set_cursor(
                self.as_ref().to_glib_none().0,
    ...
    fn set_decorations(&self, decorations: WMDecoration) {
        unsafe {
            gdk_sys::gdk_surface_set_decorations(
                self.as_ref().to_glib_none().0,
                decorations.to_glib(),
            );
        }
    ...
    fn set_focus_on_map(&self, focus_on_map: bool) {
        unsafe {
            gdk_sys::gdk_surface_set_focus_on_map(
                self.as_ref().to_glib_none().0,
    ...
    fn set_fullscreen_mode(&self, mode: FullscreenMode) {
        unsafe {
            gdk_sys::gdk_surface_set_fullscreen_mode(
                self.as_ref().to_glib_none().0,
                mode.to_glib(),
            );
        }
    ...
    fn set_geometry_hints(&self, geometry: &Geometry, geom_mask: SurfaceHints) {
        unsafe {
            gdk_sys::gdk_surface_set_geometry_hints(
                self.as_ref().to_glib_none().0,
    ...
    fn set_icon_list(&self, surfaces: &[Texture]) {
        unsafe {
            gdk_sys::gdk_surface_set_icon_list(
                self.as_ref().to_glib_none().0,
    ...
    fn set_icon_name(&self, name: Option<&str>) {
        unsafe {
            gdk_sys::gdk_surface_set_icon_name(
                self.as_ref().to_glib_none().0,
                name.to_glib_none().0,
            );
        }
    ...
    fn set_pass_through(&self, pass_through: bool) {
        unsafe {
            gdk_sys::gdk_surface_set_pass_through(
                self.as_ref().to_glib_none().0,
    ...
    fn set_shadow_width(&self, left: i32, right: i32, top: i32, bottom: i32) {
        unsafe {
            gdk_sys::gdk_surface_set_shadow_width(
                self.as_ref().to_glib_none().0,
                left,
                right,
                top,
    ...
    fn set_startup_id(&self, startup_id: &str) {
        unsafe {
            gdk_sys::gdk_surface_set_startup_id(
                self.as_ref().to_glib_none().0,
    ...
    fn set_support_multidevice(&self, support_multidevice: bool) {
        unsafe {
            gdk_sys::gdk_surface_set_support_multidevice(
                self.as_ref().to_glib_none().0,
    ...
    fn set_transient_for<P: IsA<Surface>>(&self, parent: &P) {
        unsafe {
            gdk_sys::gdk_surface_set_transient_for(
                self.as_ref().to_glib_none().0,
                parent.as_ref().to_glib_none().0,
            );
        }
    ...
    fn show_window_menu(&self, event: &Event) -> bool {
        unsafe {
            from_glib(gdk_sys::gdk_surface_show_window_menu(
                self.as_ref().to_glib_none().0,
    ...
    fn connect_event<F: Fn(&Self, &Event) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
            ...
            P: IsA<Surface>,
        {
            ...
            f(
                &Surface::from_glib_borrow(this).unsafe_cast(),
    ...
    fn connect_render<F: Fn(&Self, &cairo::Region) -> bool + 'static>(
        ...
        unsafe extern "C" fn render_trampoline<P, F: Fn(&P, &cairo::Region) -> bool + 'static>(
            this: *mut gdk_sys::GdkSurface,
    ...
    fn connect_size_changed<F: Fn(&Self, i32, i32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn size_changed_trampoline<P, F: Fn(&P, i32, i32) + 'static>(
            this: *mut gdk_sys::GdkSurface,
            width: libc::c_int,
            height: libc::c_int,
            f: glib_sys::gpointer,
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(size_changed_trampoline::<Self, F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    fn connect_property_mapped_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(notify_mapped_trampoline::<Self, F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
