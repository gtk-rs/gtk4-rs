...
impl<O: IsA<TreeListRow>> TreeListRowExt for O {
    ...
    fn get_children(&self) -> Option<gio::ListModel> {
        unsafe {
            from_glib_none(gtk_sys::gtk_tree_list_row_get_children(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn get_item(&self) -> Option<glib::Object> {
        unsafe {
            from_glib_full(gtk_sys::gtk_tree_list_row_get_item(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_property_depth_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::depth\0".as_ptr() as *const _,
                Some(transmute(notify_depth_trampoline::<Self, F> as usize)), Box_::into_raw(f))
        }
    }
    ...
    fn connect_property_expandable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::expandable\0".as_ptr() as *const _,
                Some(transmute(notify_expandable_trampoline::<Self, F> as usize)), Box_::into_raw(f))
        }
    }
