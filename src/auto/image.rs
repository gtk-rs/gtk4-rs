...
impl Image {
    ...
    //pub fn from_gicon(icon: /*Ignored*/&gio::Icon) -> Image {
    ...
    //pub fn from_paintable(paintable: /*Ignored*/Option<&gdk::Paintable>) -> Image {
    //    unsafe { TODO: call gtk_sys:gtk_image_new_from_paintable() }
    //}

    //pub fn from_pixbuf(pixbuf: /*Ignored*/Option<&gdk_pixbuf::Pixbuf>) -> Image {
    ...
    //pub fn set_from_gicon(&self, icon: /*Ignored*/&gio::Icon) {
    ...
    //pub fn set_from_paintable(&self, paintable: /*Ignored*/Option<&gdk::Paintable>) {
    //    unsafe { TODO: call gtk_sys:gtk_image_set_from_paintable() }
    //}

    //pub fn set_from_pixbuf(&self, pixbuf: /*Ignored*/Option<&gdk_pixbuf::Pixbuf>) {
    ...
    //pub fn set_property_paintable<P: IsA</*Ignored*/gdk::Paintable> + SetValueOptional>(&self, paintable: Option<&P>) {
    //    unsafe {
    //        gobject_sys::g_object_set_property(self.as_ptr() as *mut gobject_sys::GObject, b"paintable\0".as_ptr() as *const _, Value::from(paintable).to_glib_none().0);
    //    }
    //}
