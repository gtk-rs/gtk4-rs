...
impl<O: IsA<GestureSingle>> GestureSingleExt for O {
    fn get_button(&self) -> u32 {
        unsafe {
            gtk_sys::gtk_gesture_single_get_button(self.as_ref().to_glib_none().0)
        }
    }

    fn get_current_button(&self) -> u32 {
        unsafe {
            gtk_sys::gtk_gesture_single_get_current_button(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn get_exclusive(&self) -> bool {
        unsafe {
            from_glib(gtk_sys::gtk_gesture_single_get_exclusive(self.as_ref().to_glib_none().0))
        }
    }

    fn get_touch_only(&self) -> bool {
        unsafe {
            from_glib(gtk_sys::gtk_gesture_single_get_touch_only(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_exclusive(&self, exclusive: bool) {
        unsafe {
            gtk_sys::gtk_gesture_single_set_exclusive(self.as_ref().to_glib_none().0, exclusive.to_glib());
        }
    }

    fn set_touch_only(&self, touch_only: bool) {
        unsafe {
            gtk_sys::gtk_gesture_single_set_touch_only(self.as_ref().to_glib_none().0, touch_only.to_glib());
        }
    }
...
unsafe extern "C" fn notify_button_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkGestureSingle, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
where P: IsA<GestureSingle> {
    let f: &F = &*(f as *const F);
    f(&GestureSingle::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_exclusive_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkGestureSingle, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
where P: IsA<GestureSingle> {
    let f: &F = &*(f as *const F);
    f(&GestureSingle::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_touch_only_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkGestureSingle, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
where P: IsA<GestureSingle> {
    let f: &F = &*(f as *const F);
    f(&GestureSingle::from_glib_borrow(this).unsafe_cast())
}
