...
glib_wrapper! {
    pub struct Stack(Object<gtk_sys::GtkStack, StackClass>) @extends Container, Widget, @implements Buildable;
...
impl Stack {
    ...
    pub fn get_homogeneous(&self) -> bool {
        unsafe { from_glib(gtk_sys::gtk_stack_get_homogeneous(self.to_glib_none().0)) }
    }
    ...
    pub fn set_homogeneous(&self, homogeneous: bool) {
        unsafe {
            gtk_sys::gtk_stack_set_homogeneous(self.to_glib_none().0, homogeneous.to_glib());
        }
    }
    ...
    pub fn connect_property_homogeneous_notify<F: Fn(&Stack) + 'static>(
        &self,
        f: F,
    ) -> SignalHandlerId {
        unsafe extern "C" fn notify_homogeneous_trampoline<F: Fn(&Stack) + 'static>(
            this: *mut gtk_sys::GtkStack,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) {
