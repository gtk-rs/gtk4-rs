...
impl TreeListModel {
    pub fn new<P: IsA<gio::ListModel>, Q: Fn(&glib::Object) -> Option<gio::ListModel> + 'static>(passthrough: bool, root: &P, autoexpand: bool, create_func: Q) -> TreeListModel {
        assert_initialized_main_thread!();
        let create_func_data: Box_<Q> = Box::new(create_func);
        unsafe extern "C" fn create_func_func<P: IsA<gio::ListModel>, Q: Fn(&glib::Object) -> Option<gio::ListModel> + 'static>(item: *mut gobject_sys::GObject, user_data: glib_sys::gpointer) -> *mut gio_sys::GListModel {
            let item = from_glib_borrow(item);
            let callback: &Q = &*(user_data as *mut _);
            let res = (*callback)(&item);
            res/*Not checked*/.to_glib_none().0
        }
        let create_func = Some(create_func_func::<P, Q> as _);
        unsafe extern "C" fn user_destroy_func<P: IsA<gio::ListModel>, Q: Fn(&glib::Object) -> Option<gio::ListModel> + 'static>(data: glib_sys::gpointer) {
        ...
        unsafe {
            from_glib_full(gtk_sys::gtk_tree_list_model_new(passthrough.to_glib(), root.as_ref().to_glib_none().0, autoexpand.to_glib(), create_func, Box::into_raw(super_callback0) as *mut _, destroy_call5))
        }
    }
}
...
impl<O: IsA<TreeListModel>> TreeListModelExt for O {
    ...
    fn get_model(&self) -> Option<gio::ListModel> {
        unsafe {
            from_glib_none(gtk_sys::gtk_tree_list_model_get_model(self.as_ref().to_glib_none().0))
        }
    }
