...
glib_wrapper! {
    pub struct FlowBox(Object<gtk_sys::GtkFlowBox, FlowBoxClass>) @extends Container, Widget, @implements Buildable, Orientable;
...
impl FlowBox {
    ...
    //pub fn bind_model(&self, model: /*Ignored*/Option<&gio::ListModel>, create_widget_func: /*Unimplemented*/Fn(/*Ignored*/glib::Object) -> Widget, user_data: /*Unimplemented*/Option<Fundamental: Pointer>) {
    ...
    pub fn connect_move_cursor<F: Fn(&FlowBox, MovementStep, i32) -> bool + 'static>(
        &self,
        f: F,
    ) -> SignalHandlerId {
        unsafe extern "C" fn move_cursor_trampoline<
            F: Fn(&FlowBox, MovementStep, i32) -> bool + 'static,
        >(
            this: *mut gtk_sys::GtkFlowBox,
