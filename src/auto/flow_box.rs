...
unsafe extern "C" fn notify_accept_unpaired_release_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::GtkFlowBox, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<FlowBox> {
    let f: &F = &*(f as *const F);
    f(&FlowBox::from_glib_borrow(this).unsafe_cast())
}
