...
impl Button {
    ...
    pub fn new_from_icon_name(icon_name: Option<&str>) -> Button {
        assert_initialized_main_thread!();
        unsafe {
            Widget::from_glib_none(ffi::gtk_button_new_from_icon_name(icon_name.to_glib_none().0)).unsafe_cast()
        }
    }
...
impl<O: IsA<Button>> ButtonExt for O {
    ...
    fn get_icon_name(&self) -> Option<GString> {
        unsafe {
            from_glib_none(ffi::gtk_button_get_icon_name(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_icon_name(&self, icon_name: &str) {
        unsafe {
            ffi::gtk_button_set_icon_name(self.as_ref().to_glib_none().0, icon_name.to_glib_none().0);
        }
    }
...
unsafe extern "C" fn notify_icon_name_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::GtkButton, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<Button> {
    let f: &F = &*(f as *const F);
    f(&Button::from_glib_borrow(this).unsafe_cast())
}
