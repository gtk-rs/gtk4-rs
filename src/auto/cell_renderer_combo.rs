...
unsafe extern "C" fn changed_trampoline<P, F: Fn(&P, &str, &TreeIter) + 'static>(this: *mut ffi::GtkCellRendererCombo, path_string: *mut libc::c_char, new_iter: *mut ffi::GtkTreeIter, f: glib_ffi::gpointer)
