...
glib_wrapper! {
    pub struct FontChooserWidget(Object<gtk_sys::GtkFontChooserWidget, FontChooserWidgetClass>) @extends Widget, @implements Buildable, FontChooser;
...
impl FontChooserWidget {
    ...
    //pub fn get_property_tweak_action(&self) -> /*Ignored*/Option<gio::Action> {
    //    unsafe {
    //        let mut value = Value::from_type(</*Unknown type*/ as StaticType>::static_type());
    //        gobject_sys::g_object_get_property(self.as_ptr() as *mut gobject_sys::GObject, b"tweak-action\0".as_ptr() as *const _, value.to_glib_none_mut().0);
