...
impl Drag {
    ...
    pub fn get_actions(&self) -> DragAction {
        unsafe {
            from_glib(gdk_sys::gdk_drag_get_actions(self.to_glib_none().0))
        }
    }

    pub fn get_device(&self) -> Option<Device> {
        unsafe {
            from_glib_none(gdk_sys::gdk_drag_get_device(self.to_glib_none().0))
        }
    }

    pub fn get_display(&self) -> Option<Display> {
        unsafe {
            from_glib_none(gdk_sys::gdk_drag_get_display(self.to_glib_none().0))
        }
    }

    pub fn get_drag_surface(&self) -> Option<Surface> {
        unsafe {
            from_glib_none(gdk_sys::gdk_drag_get_drag_surface(self.to_glib_none().0))
        }
    }

    pub fn get_formats(&self) -> Option<ContentFormats> {
        unsafe {
            from_glib_none(gdk_sys::gdk_drag_get_formats(self.to_glib_none().0))
        }
    }

    pub fn get_selected_action(&self) -> DragAction {
        unsafe {
            from_glib(gdk_sys::gdk_drag_get_selected_action(self.to_glib_none().0))
        }
    }
    ...
    pub fn set_property_actions(&self, actions: DragAction) {
        unsafe {
            gobject_sys::g_object_set_property(self.as_ptr() as *mut gobject_sys::GObject, b"actions\0".as_ptr() as *const _, Value::from(&actions).to_glib_none().0);
        }
    }
    ...
    pub fn get_property_content(&self) -> Option<ContentProvider> {
        unsafe {
            ...
            gobject_sys::g_object_get_property(self.as_ptr() as *mut gobject_sys::GObject, b"content\0".as_ptr() as *const _, value.to_glib_none_mut().0);
            value.get()
        }
    }
    ...
    pub fn set_property_selected_action(&self, selected_action: DragAction) {
        unsafe {
            gobject_sys::g_object_set_property(self.as_ptr() as *mut gobject_sys::GObject, b"selected-action\0".as_ptr() as *const _, Value::from(&selected_action).to_glib_none().0);
        }
    }
    ...
    pub fn get_property_surface(&self) -> Option<Surface> {
        unsafe {
            ...
            gobject_sys::g_object_get_property(self.as_ptr() as *mut gobject_sys::GObject, b"surface\0".as_ptr() as *const _, value.to_glib_none_mut().0);
            value.get()
        }
    }
    ...
    pub fn begin<P: IsA<Surface>, Q: IsA<ContentProvider>>(surface: &P, device: &Device, content: &Q, actions: DragAction, dx: i32, dy: i32) -> Option<Drag> {
        ...
        unsafe {
            from_glib_full(gdk_sys::gdk_drag_begin(surface.as_ref().to_glib_none().0, device.to_glib_none().0, content.as_ref().to_glib_none().0, actions.to_glib(), dx, dy))
        }
    }

    pub fn connect_cancel<F: Fn(&Drag, DragCancelReason) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn cancel_trampoline<F: Fn(&Drag, DragCancelReason) + 'static>(this: *mut gdk_sys::GdkDrag, reason: gdk_sys::GdkDragCancelReason, f: glib_sys::gpointer) {
    ...
    pub fn connect_dnd_finished<F: Fn(&Drag) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn dnd_finished_trampoline<F: Fn(&Drag) + 'static>(this: *mut gdk_sys::GdkDrag, f: glib_sys::gpointer) {
            let f: &F = &*(f as *const F);
    ...
    pub fn connect_drop_performed<F: Fn(&Drag) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn drop_performed_trampoline<F: Fn(&Drag) + 'static>(this: *mut gdk_sys::GdkDrag, f: glib_sys::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
    ...
    pub fn connect_property_actions_notify<F: Fn(&Drag) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_actions_trampoline<F: Fn(&Drag) + 'static>(this: *mut gdk_sys::GdkDrag, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
    ...
    pub fn connect_property_display_notify<F: Fn(&Drag) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_display_trampoline<F: Fn(&Drag) + 'static>(this: *mut gdk_sys::GdkDrag, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
    ...
    pub fn connect_property_selected_action_notify<F: Fn(&Drag) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_selected_action_trampoline<F: Fn(&Drag) + 'static>(this: *mut gdk_sys::GdkDrag, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
