...
impl TreeView {
    ...
    //pub fn create_row_drag_icon(&self, path: &TreePath) -> /*Ignored*/Option<gdk::Paintable> {
    ...
    //pub fn get_background_area(&self, path: Option<&TreePath>, column: Option<&TreeViewColumn>, rect: /*Ignored*/gdk::Rectangle) {
    //    unsafe { TODO: call gtk_sys:gtk_tree_view_get_background_area() }
    //}

    //pub fn get_cell_area(&self, path: Option<&TreePath>, column: Option<&TreeViewColumn>, rect: /*Ignored*/gdk::Rectangle) {
    ...
    //pub fn get_visible_rect(&self, visible_rect: /*Ignored*/gdk::Rectangle) {
