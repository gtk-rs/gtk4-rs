...
pub trait DrawingAreaExt: 'static {
    ...
    fn set_draw_func(
        &self,
        draw_func: Option<Box<dyn Fn(&DrawingArea, &cairo::Context, i32, i32) + 'static>>,
    );
...
impl<O: IsA<DrawingArea>> DrawingAreaExt for O {
    ...
    fn set_draw_func(
        ...
        let draw_func_data: Box_<
            Option<Box<dyn Fn(&DrawingArea, &cairo::Context, i32, i32) + 'static>>,
        > = Box::new(draw_func);
        unsafe extern "C" fn draw_func_func(
            ...
            let callback: &Option<Box<dyn Fn(&DrawingArea, &cairo::Context, i32, i32) + 'static>> =
                &*(user_data as *mut _);
    ...
    fn connect_property_content_height_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(
                    notify_content_height_trampoline::<Self, F> as usize,
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_property_content_width_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(
                    notify_content_width_trampoline::<Self, F> as usize,
                )),
                Box_::into_raw(f),
            )
        }
