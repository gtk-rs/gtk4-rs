...
impl CssSection {
    ...
    //    unsafe { TODO: call ffi::gtk_css_section_new() }
    //}

    //pub fn get_end_location(&self) -> /*Ignored*/Option<CssLocation> {
    //    unsafe { TODO: call ffi::gtk_css_section_get_end_location() }
    //}
    ...
    //    unsafe { TODO: call ffi::gtk_css_section_get_start_location() }
    //}

    //pub fn print(&self, string: /*Ignored*/&mut glib::String) {
    //    unsafe { TODO: call ffi::gtk_css_section_print() }
    //}

    fn to_string(&self) -> GString {
        unsafe {
            from_glib_full(ffi::gtk_css_section_to_string(self.to_glib_none().0))
        }
    }
}
