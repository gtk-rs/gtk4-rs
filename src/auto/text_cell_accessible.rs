...
glib_wrapper! {
    pub struct TextCellAccessible(Object<ffi::GtkTextCellAccessible, ffi::GtkTextCellAccessibleClass, TextCellAccessibleClass>) @extends RendererCellAccessible, CellAccessible, Accessible;
