...
glib_wrapper! {
    pub struct ColorChooserWidget(Object<gtk_sys::GtkColorChooserWidget, ColorChooserWidgetClass>) @extends Widget, @implements Accessible, Buildable, ColorChooser;
