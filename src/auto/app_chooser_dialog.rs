...
glib_wrapper! {
    pub struct AppChooserDialog(Object<gtk_sys::GtkAppChooserDialog, AppChooserDialogClass>) @extends Dialog, Window, Bin, Container, Widget, @implements Buildable, Root, AppChooser;
...
impl AppChooserDialog {
    ...
    //        gobject_sys::g_object_get_property(self.as_ptr() as *mut gobject_sys::GObject, b"gfile\0".as_ptr() as *const _, value.to_glib_none_mut().0);
