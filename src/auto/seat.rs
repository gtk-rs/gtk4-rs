...
impl Seat {
    ...
    pub fn get_master_pointers(&self, capabilities: SeatCapabilities) -> Vec<Device> {
        unsafe {
            FromGlibPtrContainer::from_glib_container(gdk_sys::gdk_seat_get_master_pointers(self.to_glib_none().0, capabilities.to_glib()))
        }
    }
    ...
    pub fn grab<P: IsA<Surface>>(&self, surface: &P, capabilities: SeatCapabilities, owner_events: bool, cursor: Option<&Cursor>, event: Option<&Event>, prepare_func: Option<&mut dyn (FnMut(&Seat, &Surface))>) -> GrabStatus {
        ...
        unsafe extern "C" fn prepare_func_func<P: IsA<Surface>>(seat: *mut gdk_sys::GdkSeat, surface: *mut gdk_sys::GdkSurface, user_data: glib_sys::gpointer) {
        ...
        unsafe {
            from_glib(gdk_sys::gdk_seat_grab(self.to_glib_none().0, surface.as_ref().to_glib_none().0, capabilities.to_glib(), owner_events.to_glib(), cursor.to_glib_none().0, event.to_glib_none().0, prepare_func, super_callback0 as *const _ as usize as *mut _))
        }
    }
