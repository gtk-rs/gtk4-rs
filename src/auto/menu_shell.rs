...
unsafe extern "C" fn move_selected_trampoline<P, F: Fn(&P, i32) -> bool + 'static>(this: *mut ffi::GtkMenuShell, distance: libc::c_int, f: glib_ffi::gpointer) -> glib_ffi::gboolean
where P: IsA<MenuShell> {
    let f: &F = &*(f as *const F);
