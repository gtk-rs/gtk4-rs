...
glib_wrapper! {
    pub struct FontChooserDialog(Object<gtk_sys::GtkFontChooserDialog, FontChooserDialogClass>) @extends Dialog, Window, Bin, Container, Widget, @implements Buildable, Root, FontChooser;
