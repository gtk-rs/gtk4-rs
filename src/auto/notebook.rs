...
impl<O: IsA<Notebook>> NotebookExt for O {
    fn append_page<P: IsA<Widget>, Q: IsA<Widget>>(&self, child: &P, tab_label: Option<&Q>) -> i32 {
        unsafe {
            ffi::gtk_notebook_append_page(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0, tab_label.map(|p| p.as_ref()).to_glib_none().0)
        }
    }

    fn append_page_menu<P: IsA<Widget>, Q: IsA<Widget>, R: IsA<Widget>>(&self, child: &P, tab_label: Option<&Q>, menu_label: Option<&R>) -> i32 {
        unsafe {
            ffi::gtk_notebook_append_page_menu(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0, tab_label.map(|p| p.as_ref()).to_glib_none().0, menu_label.map(|p| p.as_ref()).to_glib_none().0)
        }
    }
    ...
    fn get_current_page(&self) -> i32 {
        unsafe {
            ffi::gtk_notebook_get_current_page(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn get_n_pages(&self) -> i32 {
        unsafe {
            ffi::gtk_notebook_get_n_pages(self.as_ref().to_glib_none().0)
        }
    }

    fn get_nth_page(&self, page_num: i32) -> Option<Widget> {
        unsafe {
            from_glib_none(ffi::gtk_notebook_get_nth_page(self.as_ref().to_glib_none().0, page_num))
        }
    }

    fn get_page<P: IsA<Widget>>(&self, child: &P) -> Option<NotebookPage> {
        unsafe {
            from_glib_none(ffi::gtk_notebook_get_page(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0))
        }
    }

    //fn get_pages(&self) -> /*Ignored*/Option<gio::ListModel> {
    //    unsafe { TODO: call ffi::gtk_notebook_get_pages() }
    //}
    ...
    fn insert_page<P: IsA<Widget>, Q: IsA<Widget>>(&self, child: &P, tab_label: Option<&Q>, position: i32) -> i32 {
        unsafe {
            ffi::gtk_notebook_insert_page(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0, tab_label.map(|p| p.as_ref()).to_glib_none().0, position)
        }
    }

    fn insert_page_menu<P: IsA<Widget>, Q: IsA<Widget>, R: IsA<Widget>>(&self, child: &P, tab_label: Option<&Q>, menu_label: Option<&R>, position: i32) -> i32 {
        unsafe {
            ffi::gtk_notebook_insert_page_menu(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0, tab_label.map(|p| p.as_ref()).to_glib_none().0, menu_label.map(|p| p.as_ref()).to_glib_none().0, position)
        }
    }
    ...
    fn page_num<P: IsA<Widget>>(&self, child: &P) -> i32 {
        unsafe {
            ffi::gtk_notebook_page_num(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0)
        }
    }
    ...
    fn prepend_page<P: IsA<Widget>, Q: IsA<Widget>>(&self, child: &P, tab_label: Option<&Q>) -> i32 {
        unsafe {
            ffi::gtk_notebook_prepend_page(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0, tab_label.map(|p| p.as_ref()).to_glib_none().0)
        }
    }

    fn prepend_page_menu<P: IsA<Widget>, Q: IsA<Widget>, R: IsA<Widget>>(&self, child: &P, tab_label: Option<&Q>, menu_label: Option<&R>) -> i32 {
        unsafe {
            ffi::gtk_notebook_prepend_page_menu(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0, tab_label.map(|p| p.as_ref()).to_glib_none().0, menu_label.map(|p| p.as_ref()).to_glib_none().0)
        }
    }
    ...
    fn remove_page(&self, page_num: i32) {
        unsafe {
            ffi::gtk_notebook_remove_page(self.as_ref().to_glib_none().0, page_num);
        }
    }

    fn reorder_child<P: IsA<Widget>>(&self, child: &P, position: i32) {
        unsafe {
            ffi::gtk_notebook_reorder_child(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0, position);
        }
    }
...
unsafe extern "C" fn notify_pages_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::GtkNotebook, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<Notebook> {
    let f: &F = &*(f as *const F);
    f(&Notebook::from_glib_borrow(this).unsafe_cast())
}
