...
impl AppChooserWidget {
    ...
    //pub fn connect_application_activated<Unsupported or ignored types>(&self, f: F) -> SignalHandlerId {
    //    Ignored application: Gio.AppInfo
    //}

    //pub fn connect_application_selected<Unsupported or ignored types>(&self, f: F) -> SignalHandlerId {
    //    Ignored application: Gio.AppInfo
    //}
