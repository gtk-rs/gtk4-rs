...
impl<O: IsA<TreeModelFilter>> TreeModelFilterExt for O {
    ...
    fn convert_child_iter_to_iter(&self, child_iter: &mut TreeIter) -> Option<TreeIter> {
        unsafe {
            ...
            let ret = from_glib(ffi::gtk_tree_model_filter_convert_child_iter_to_iter(self.as_ref().to_glib_none().0, filter_iter.to_glib_none_mut().0, child_iter.to_glib_none_mut().0));
    ...
    fn convert_child_path_to_path(&self, child_path: &mut TreePath) -> Option<TreePath> {
        unsafe {
            from_glib_full(ffi::gtk_tree_model_filter_convert_child_path_to_path(self.as_ref().to_glib_none().0, child_path.to_glib_none_mut().0))
        }
    }
    ...
    fn convert_iter_to_child_iter(&self, filter_iter: &mut TreeIter) -> TreeIter {
        unsafe {
            ...
            ffi::gtk_tree_model_filter_convert_iter_to_child_iter(self.as_ref().to_glib_none().0, child_iter.to_glib_none_mut().0, filter_iter.to_glib_none_mut().0);
            child_iter
        }
    }
    ...
    fn convert_path_to_child_path(&self, filter_path: &mut TreePath) -> Option<TreePath> {
        unsafe {
            from_glib_full(ffi::gtk_tree_model_filter_convert_path_to_child_path(self.as_ref().to_glib_none().0, filter_path.to_glib_none_mut().0))
        }
    }
    ...
    fn get_property_virtual_root(&self) -> Option<TreePath> {
        unsafe {
            ...
            gobject_ffi::g_object_get_property(self.to_glib_none().0 as *mut gobject_ffi::GObject, b"virtual-root\0".as_ptr() as *const _, value.to_glib_none_mut().0);
            value.get()
        }
    }
}
