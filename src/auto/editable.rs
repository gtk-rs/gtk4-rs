...
glib_wrapper! {
    pub struct Editable(Interface<ffi::GtkEditable>) @requires Widget, Buildable;
...
impl Editable {
    ...
    //    unsafe { TODO: call ffi::gtk_editable_delegate_get_property() }
    //}
    ...
    //    unsafe { TODO: call ffi::gtk_editable_delegate_set_property() }
    //}
...
impl<O: IsA<Editable>> EditableExt for O {
    ...
    fn get_alignment(&self) -> f32 {
        unsafe {
            ffi::gtk_editable_get_alignment(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn get_max_width_chars(&self) -> i32 {
        unsafe {
            ffi::gtk_editable_get_max_width_chars(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn get_text(&self) -> Option<GString> {
        unsafe {
            from_glib_none(ffi::gtk_editable_get_text(self.as_ref().to_glib_none().0))
        }
    }

    fn get_width_chars(&self) -> i32 {
        unsafe {
            ffi::gtk_editable_get_width_chars(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn insert_text(&self, text: &str, position: &mut i32) {
        ...
        unsafe {
            ffi::gtk_editable_insert_text(self.as_ref().to_glib_none().0, text.to_glib_none().0, length, position);
        }
    }
...
unsafe extern "C" fn changed_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::GtkEditable, f: glib_ffi::gpointer)
where P: IsA<Editable> {
    let f: &F = &*(f as *const F);
    f(&Editable::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn delete_text_trampoline<P, F: Fn(&P, i32, i32) + 'static>(this: *mut ffi::GtkEditable, start_pos: libc::c_int, end_pos: libc::c_int, f: glib_ffi::gpointer)
where P: IsA<Editable> {
    let f: &F = &*(f as *const F);
    f(&Editable::from_glib_borrow(this).unsafe_cast(), start_pos, end_pos)
}

unsafe extern "C" fn notify_cursor_position_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::GtkEditable, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<Editable> {
    let f: &F = &*(f as *const F);
    f(&Editable::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_editable_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::GtkEditable, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<Editable> {
    let f: &F = &*(f as *const F);
    f(&Editable::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_max_width_chars_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::GtkEditable, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<Editable> {
    let f: &F = &*(f as *const F);
    f(&Editable::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_selection_bound_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::GtkEditable, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<Editable> {
    let f: &F = &*(f as *const F);
    f(&Editable::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_text_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::GtkEditable, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<Editable> {
    let f: &F = &*(f as *const F);
    f(&Editable::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_width_chars_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::GtkEditable, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<Editable> {
    let f: &F = &*(f as *const F);
    f(&Editable::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_xalign_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::GtkEditable, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<Editable> {
    let f: &F = &*(f as *const F);
    f(&Editable::from_glib_borrow(this).unsafe_cast())
}
