...
impl<O: IsA<CellRendererText>> CellRendererTextExt for O {
    ...
    //    unsafe {
    //        let mut value = Value::from_type(</*Unknown type*/ as StaticType>::static_type());
    //        gobject_ffi::g_object_get_property(self.to_glib_none().0 as *mut gobject_ffi::GObject, b"attributes\0".as_ptr() as *const _, value.to_glib_none_mut().0);
    //        value.get()
    //    }
    //}
    ...
    //fn set_property_attributes(&self, attributes: /*Ignored*/Option<&pango::AttrList>) {
    //    unsafe {
    //        gobject_ffi::g_object_set_property(self.to_glib_none().0 as *mut gobject_ffi::GObject, b"attributes\0".as_ptr() as *const _, Value::from(attributes).to_glib_none().0);
    //    }
    //}
    ...
    //    unsafe {
    //        let mut value = Value::from_type(</*Unknown type*/ as StaticType>::static_type());
    //        gobject_ffi::g_object_get_property(self.to_glib_none().0 as *mut gobject_ffi::GObject, b"font-desc\0".as_ptr() as *const _, value.to_glib_none_mut().0);
    //        value.get()
    //    }
    //}
    ...
    //fn set_property_font_desc(&self, font_desc: /*Ignored*/Option<&pango::FontDescription>) {
    //    unsafe {
    //        gobject_ffi::g_object_set_property(self.to_glib_none().0 as *mut gobject_ffi::GObject, b"font-desc\0".as_ptr() as *const _, Value::from(font_desc).to_glib_none().0);
    //    }
    //}
...
unsafe extern "C" fn edited_trampoline<P, F: Fn(&P, &str, &str) + 'static>(this: *mut ffi::GtkCellRendererText, path: *mut libc::c_char, new_text: *mut libc::c_char, f: glib_ffi::gpointer)
...
unsafe extern "C" fn notify_attributes_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::GtkCellRendererText, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<CellRendererText> {
    let f: &F = &*(f as *const F);
    f(&CellRendererText::from_glib_borrow(this).unsafe_cast())
}
...
unsafe extern "C" fn notify_font_desc_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::GtkCellRendererText, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<CellRendererText> {
    let f: &F = &*(f as *const F);
    f(&CellRendererText::from_glib_borrow(this).unsafe_cast())
}
