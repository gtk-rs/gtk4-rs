...
pub trait DialogExt: 'static {
    //fn add_action_widget<P: IsA<Widget>>(&self, child: &P, response_id: /*Ignored*/ResponseType);

    //fn add_button(&self, button_text: &str, response_id: /*Ignored*/ResponseType) -> Widget;
    ...
    //fn get_widget_for_response(&self, response_id: /*Ignored*/ResponseType) -> Option<Widget>;

    //fn response(&self, response_id: /*Ignored*/ResponseType);

    //fn set_default_response(&self, response_id: /*Ignored*/ResponseType);

    //fn set_response_sensitive(&self, response_id: /*Ignored*/ResponseType, setting: bool);
...
impl<O: IsA<Dialog>> DialogExt for O {
    //fn add_action_widget<P: IsA<Widget>>(&self, child: &P, response_id: /*Ignored*/ResponseType) {
    //    unsafe { TODO: call gtk_sys:gtk_dialog_add_action_widget() }
    //}

    //fn add_button(&self, button_text: &str, response_id: /*Ignored*/ResponseType) -> Widget {
    //    unsafe { TODO: call gtk_sys:gtk_dialog_add_button() }
    //}
    ...
    //fn get_widget_for_response(&self, response_id: /*Ignored*/ResponseType) -> Option<Widget> {
    //    unsafe { TODO: call gtk_sys:gtk_dialog_get_widget_for_response() }
    //}

    //fn response(&self, response_id: /*Ignored*/ResponseType) {
    //    unsafe { TODO: call gtk_sys:gtk_dialog_response() }
    //}

    //fn set_default_response(&self, response_id: /*Ignored*/ResponseType) {
    //    unsafe { TODO: call gtk_sys:gtk_dialog_set_default_response() }
    //}

    //fn set_response_sensitive(&self, response_id: /*Ignored*/ResponseType, setting: bool) {
    //    unsafe { TODO: call gtk_sys:gtk_dialog_set_response_sensitive() }
    //}
