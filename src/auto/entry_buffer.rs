...
impl<O: IsA<EntryBuffer>> EntryBufferExt for O {
    fn emit_deleted_text(&self, position: u32, n_chars: u32) {
        unsafe {
            gtk_sys::gtk_entry_buffer_emit_deleted_text(self.as_ref().to_glib_none().0, position, n_chars);
        }
    }

    fn emit_inserted_text(&self, position: u32, chars: &str, n_chars: u32) {
        unsafe {
            gtk_sys::gtk_entry_buffer_emit_inserted_text(self.as_ref().to_glib_none().0, position, chars.to_glib_none().0, n_chars);
        }
    }
    ...
    fn get_property_max_length(&self) -> i32 {
        unsafe {
            ...
            gobject_sys::g_object_get_property(self.to_glib_none().0 as *mut gobject_sys::GObject, b"max-length\0".as_ptr() as *const _, value.to_glib_none_mut().0);
            value.get().unwrap()
        }
    }
    ...
    fn set_property_max_length(&self, max_length: i32) {
        unsafe {
            gobject_sys::g_object_set_property(self.to_glib_none().0 as *mut gobject_sys::GObject, b"max-length\0".as_ptr() as *const _, Value::from(&max_length).to_glib_none().0);
        }
    }
...
unsafe extern "C" fn notify_length_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkEntryBuffer, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
where P: IsA<EntryBuffer> {
    let f: &F = &*(f as *const F);
    f(&EntryBuffer::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_max_length_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkEntryBuffer, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
where P: IsA<EntryBuffer> {
    let f: &F = &*(f as *const F);
    f(&EntryBuffer::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_text_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkEntryBuffer, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
where P: IsA<EntryBuffer> {
    let f: &F = &*(f as *const F);
    f(&EntryBuffer::from_glib_borrow(this).unsafe_cast())
}
