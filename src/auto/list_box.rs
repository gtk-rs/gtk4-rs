...
impl<O: IsA<ListBox>> ListBoxExt for O {
    ...
    fn get_show_separators(&self) -> bool {
        unsafe {
            from_glib(gtk_sys::gtk_list_box_get_show_separators(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_show_separators(&self, show_separators: bool) {
        unsafe {
            gtk_sys::gtk_list_box_set_show_separators(self.as_ref().to_glib_none().0, show_separators.to_glib());
        }
    }
    ...
    fn connect_property_accept_unpaired_release_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accept_unpaired_release_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkListBox, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
            where P: IsA<ListBox>
        {
            let f: &F = &*(f as *const F);
            f(&ListBox::from_glib_borrow(this).unsafe_cast())
    ...
    fn connect_property_show_separators_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_separators_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkListBox, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
            where P: IsA<ListBox>
        {
            let f: &F = &*(f as *const F);
            f(&ListBox::from_glib_borrow(this).unsafe_cast())
