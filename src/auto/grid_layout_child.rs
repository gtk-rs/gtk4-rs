...
impl<O: IsA<GridLayoutChild>> GridLayoutChildExt for O {
    fn get_column_span(&self) -> i32 {
        unsafe {
            gtk_sys::gtk_grid_layout_child_get_column_span(self.as_ref().to_glib_none().0)
        }
    }

    fn get_left_attach(&self) -> i32 {
        unsafe {
            gtk_sys::gtk_grid_layout_child_get_left_attach(self.as_ref().to_glib_none().0)
        }
    }

    fn get_row_span(&self) -> i32 {
        unsafe {
            gtk_sys::gtk_grid_layout_child_get_row_span(self.as_ref().to_glib_none().0)
        }
    }

    fn get_top_attach(&self) -> i32 {
        unsafe {
            gtk_sys::gtk_grid_layout_child_get_top_attach(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn connect_property_column_span_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::column-span\0".as_ptr() as *const _,
                Some(transmute(notify_column_span_trampoline::<Self, F> as usize)), Box_::into_raw(f))
        }
    }
    ...
    fn connect_property_left_attach_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::left-attach\0".as_ptr() as *const _,
                Some(transmute(notify_left_attach_trampoline::<Self, F> as usize)), Box_::into_raw(f))
        }
    }
