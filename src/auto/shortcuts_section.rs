    ...
    pub fn connect_property_max_height_notify<F: Fn(&ShortcutsSection) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(notify_max_height_trampoline::<F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    pub fn connect_property_section_name_notify<F: Fn(&ShortcutsSection) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(notify_section_name_trampoline::<F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    pub fn connect_property_view_name_notify<F: Fn(&ShortcutsSection) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(notify_view_name_trampoline::<F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
