...
glib_wrapper! {
    pub struct FlowBoxAccessible(Object<ffi::GtkFlowBoxAccessible, ffi::GtkFlowBoxAccessibleClass, FlowBoxAccessibleClass>) @extends ContainerAccessible, WidgetAccessible, Accessible, atk::Object;
