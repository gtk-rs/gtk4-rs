...
glib_wrapper! {
    pub struct Clipboard(Object<ffi::GdkClipboard, ClipboardClass>);
...
impl Clipboard {
    pub fn get_content(&self) -> Option<ContentProvider> {
        unsafe {
            from_glib_none(ffi::gdk_clipboard_get_content(self.to_glib_none().0))
        }
    }

    pub fn get_display(&self) -> Option<Display> {
        unsafe {
            from_glib_none(ffi::gdk_clipboard_get_display(self.to_glib_none().0))
        }
    }

    pub fn get_formats(&self) -> Option<ContentFormats> {
        unsafe {
            from_glib_none(ffi::gdk_clipboard_get_formats(self.to_glib_none().0))
        }
    }

    pub fn is_local(&self) -> bool {
        unsafe {
            from_glib(ffi::gdk_clipboard_is_local(self.to_glib_none().0))
        }
    }
    ...
    //    unsafe { TODO: call ffi::gdk_clipboard_read_async() }
    //}
    ...
    //    unsafe { TODO: call ffi::gdk_clipboard_read_text_async() }
    //}
    ...
    //    unsafe { TODO: call ffi::gdk_clipboard_read_texture_async() }
    //}

    //#[cfg(feature = "futures")]
    //pub fn read_texture_async_future(&self) -> Box_<futures_core::Future<Item = (Self, Texture), Error = (Self, Error)>> where Self: Sized + Clone {
        //use gio::GioFuture;
        //use fragile::Fragile;
    ...
    //    unsafe { TODO: call ffi::gdk_clipboard_read_value_async() }
    //}
    ...
    pub fn set_content<P: IsA<ContentProvider>>(&self, provider: Option<&P>) -> bool {
        unsafe {
            from_glib(ffi::gdk_clipboard_set_content(self.to_glib_none().0, provider.map(|p| p.as_ref()).to_glib_none().0))
        }
    }
    ...
    pub fn set_texture<P: IsA<Texture>>(&self, texture: &P) {
        unsafe {
            ffi::gdk_clipboard_set_texture(self.to_glib_none().0, texture.as_ref().to_glib_none().0);
        }
    }
    ...
    //    unsafe { TODO: call ffi::gdk_clipboard_set_value() }
    //}
    ...
    //    unsafe { TODO: call ffi::gdk_clipboard_store_async() }
    //}

    //#[cfg(feature = "futures")]
    //pub fn store_async_future(&self, io_priority: /*Ignored*/glib::Priority) -> Box_<futures_core::Future<Item = (Self, ()), Error = (Self, Error)>> where Self: Sized + Clone {
        //use gio::GioFuture;
        //use fragile::Fragile;
    ...
    pub fn get_property_local(&self) -> bool {
        unsafe {
            ...
            gobject_ffi::g_object_get_property(self.as_ptr() as *mut gobject_ffi::GObject, b"local\0".as_ptr() as *const _, value.to_glib_none_mut().0);
            value.get().unwrap()
        }
    }
...
unsafe extern "C" fn changed_trampoline<F: Fn(&Clipboard) + 'static>(this: *mut ffi::GdkClipboard, f: glib_ffi::gpointer) {
    let f: &F = &*(f as *const F);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_content_trampoline<F: Fn(&Clipboard) + 'static>(this: *mut ffi::GdkClipboard, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &F = &*(f as *const F);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_formats_trampoline<F: Fn(&Clipboard) + 'static>(this: *mut ffi::GdkClipboard, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &F = &*(f as *const F);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_local_trampoline<F: Fn(&Clipboard) + 'static>(this: *mut ffi::GdkClipboard, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &F = &*(f as *const F);
    f(&from_glib_borrow(this))
}
