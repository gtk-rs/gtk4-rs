...
unsafe extern "C" fn state_set_trampoline<P, F: Fn(&P, bool) -> bool + 'static>(this: *mut ffi::GtkSwitch, state: glib_ffi::gboolean, f: glib_ffi::gpointer) -> glib_ffi::gboolean
where P: IsA<Switch> {
    let f: &F = &*(f as *const F);
