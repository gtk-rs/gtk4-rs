...
glib::wrapper! {
    #[doc(alias = "GtkSpinner")]
    pub struct Spinner(Object<ffi::GtkSpinner>) @extends Widget, @implements Buildable, ConstraintTarget;
...
impl SpinnerBuilder {
    ...
    pub fn spinning(self, spinning: bool) -> Self {
        Self {
            builder: self.builder.property("spinning", spinning),
        }
    }
