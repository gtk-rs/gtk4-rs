...
glib::wrapper! {
    #[doc(alias = "GtkCalendar")]
    pub struct Calendar(Object<ffi::GtkCalendar>) @extends Widget, @implements Buildable, ConstraintTarget;
...
impl Calendar {
    ...
    #[doc(alias = "gtk_calendar_set_date")]
    #[doc(alias = "date")]
    pub fn set_date(&self, date: &glib::DateTime) {
        unsafe {
            ffi::gtk_calendar_set_date(self.to_glib_none().0, date.to_glib_none().0);
        }
    }
    ...
    #[cfg(not(feature = "v4_20"))]
    #[cfg_attr(docsrs, doc(cfg(not(feature = "v4_20"))))]
    pub fn set_date(&self, date: Option<&glib::DateTime>) {
        ObjectExt::set_property(self, "date", date)
    }
    ...
    #[doc(alias = "date")]
    pub fn connect_date_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_date_trampoline<F: Fn(&Calendar) + 'static>(
            this: *mut ffi::GtkCalendar,
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_date_trampoline::<F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
