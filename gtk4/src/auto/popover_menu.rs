...
use crate::{
    ...
    PopoverMenuFlags, PositionType, ShortcutManager, Widget, ffi,
};
use glib::{
    prelude::*,
...
glib::wrapper! {
    #[doc(alias = "GtkPopoverMenu")]
    pub struct PopoverMenu(Object<ffi::GtkPopoverMenu>) @extends Popover, Widget, @implements Buildable, ConstraintTarget, Native, ShortcutManager;
