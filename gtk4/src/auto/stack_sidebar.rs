...
use crate::{
    AccessibleRole, Align, Buildable, ConstraintTarget, LayoutManager, Overflow, Stack, Widget, ffi,
};
use glib::{
    prelude::*,
...
glib::wrapper! {
    #[doc(alias = "GtkStackSidebar")]
    pub struct StackSidebar(Object<ffi::GtkStackSidebar>) @extends Widget, @implements Buildable, ConstraintTarget;
