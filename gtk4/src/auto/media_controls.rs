...
use crate::{
    AccessibleRole, Align, Buildable, ConstraintTarget, LayoutManager, MediaStream, Overflow,
    Widget, ffi,
};
use glib::{
    prelude::*,
...
glib::wrapper! {
    #[doc(alias = "GtkMediaControls")]
    pub struct MediaControls(Object<ffi::GtkMediaControls, ffi::GtkMediaControlsClass>) @extends Widget, @implements Buildable, ConstraintTarget;
