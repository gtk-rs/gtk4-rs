...
impl SearchBar {
    ...
    #[doc(alias = "key-capture-widget")]
    pub fn set_key_capture_widget<'a, P: IsA<Widget>>(&self, widget: impl Into<Option<&'a P>>) {
        unsafe {
...
impl SearchBarBuilder {
    ...
    pub fn key_capture_widget<'a, P: IsA<Widget>>(
        self,
        key_capture_widget: impl Into<Option<&'a P>>,
    ) -> Self {
        Self {
            builder: self.builder.property(
                "key-capture-widget",
                key_capture_widget.into().as_ref().map(|p| p.as_ref()),
            ),
        }
    }
