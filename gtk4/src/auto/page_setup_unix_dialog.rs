...
impl PageSetupUnixDialog {
    ...
    pub fn builder() -> PageSetupUnixDialogBuilder {
        PageSetupUnixDialogBuilder::new()
    }
    ...
    pub fn set_print_settings<'a>(&self, print_settings: impl Into<Option<&'a PrintSettings>>) {
        unsafe {
...
pub struct PageSetupUnixDialogBuilder {
    builder: glib::object::ObjectBuilder<'static, PageSetupUnixDialog>,
}
