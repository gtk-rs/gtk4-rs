...
use crate::{
    AccessibleRole, Align, Application, Buildable, ColorChooser, ConstraintTarget, Dialog,
    LayoutManager, Native, Overflow, Root, ShortcutManager, Widget, Window, ffi,
};
use glib::{
    prelude::*,
...
glib::wrapper! {
    #[doc(alias = "GtkColorChooserDialog")]
    pub struct ColorChooserDialog(Object<ffi::GtkColorChooserDialog>) @extends Dialog, Window, Widget, @implements Buildable, ConstraintTarget, Native, Root, ShortcutManager, ColorChooser;
