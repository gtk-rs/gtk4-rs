...
glib::wrapper! {
    #[doc(alias = "GtkCenterBox")]
    pub struct CenterBox(Object<ffi::GtkCenterBox, ffi::GtkCenterBoxClass>) @extends Widget, @implements Buildable, ConstraintTarget, Orientable;
...
impl CenterBox {
    ...
    pub fn connect_shrink_center_last_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::shrink-center-last".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
