...
use crate::{
    AccessibleRole, Align, Buildable, ConstraintTarget, IconSize, ImageType, LayoutManager,
    Overflow, Widget, ffi,
};
use glib::{
    prelude::*,
...
glib::wrapper! {
    #[doc(alias = "GtkImage")]
    pub struct Image(Object<ffi::GtkImage>) @extends Widget, @implements Buildable, ConstraintTarget;
