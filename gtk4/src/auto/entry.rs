...
use crate::{
    AccessibleRole, Align, Buildable, CellEditable, ConstraintTarget, Editable, EntryBuffer,
    EntryCompletion, EntryIconPosition, ImageType, InputHints, InputPurpose, LayoutManager,
    Overflow, Widget, ffi,
};
use glib::{
...
glib::wrapper! {
    #[doc(alias = "GtkEntry")]
    pub struct Entry(Object<ffi::GtkEntry, ffi::GtkEntryClass>) @extends Widget, @implements Buildable, ConstraintTarget, CellEditable, Editable;
...
pub trait EntryExt: IsA<Entry> + 'static {
    ...
    fn connect_menu_entry_icon_primary_text_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::menu-entry-icon-primary-text".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
    ...
    fn connect_menu_entry_icon_secondary_text_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::menu-entry-icon-secondary-text".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
    ...
    fn connect_primary_icon_paintable_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::primary-icon-paintable".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
    ...
    fn connect_secondary_icon_paintable_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::secondary-icon-paintable".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
