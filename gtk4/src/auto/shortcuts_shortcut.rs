...
impl ShortcutsShortcut {
    ...
    pub fn set_accelerator<'a>(&self, accelerator: impl Into<Option<&'a str>>) {
        ObjectExt::set_property(self, "accelerator", accelerator.into())
    }
    ...
    #[doc(alias = "action-name")]
    pub fn set_action_name<'a>(&self, action_name: impl Into<Option<&'a str>>) {
        ObjectExt::set_property(self, "action-name", action_name.into())
    }
    ...
    pub fn set_icon<'a, P: IsA<gio::Icon>>(&self, icon: impl Into<Option<&'a P>>) {
        ObjectExt::set_property(self, "icon", icon.into().as_ref().map(|p| p.as_ref()))
    }
    ...
    pub fn set_subtitle<'a>(&self, subtitle: impl Into<Option<&'a str>>) {
        ObjectExt::set_property(self, "subtitle", subtitle.into())
    }
...
impl ShortcutsShortcutBuilder {
    ...
    pub fn accelerator<'a>(self, accelerator: impl Into<Option<&'a str>>) -> Self {
        Self {
    ...
    pub fn icon<'a, P: IsA<gio::Icon>>(self, icon: impl Into<Option<&'a P>>) -> Self {
        Self {
            builder: self
                .builder
                .property("icon", icon.into().as_ref().map(|p| p.as_ref())),
        }
    }
    ...
    pub fn subtitle<'a>(self, subtitle: impl Into<Option<&'a str>>) -> Self {
        Self {
