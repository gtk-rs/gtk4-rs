...
impl ColorDialogButton {
    ...
    pub fn builder() -> ColorDialogButtonBuilder {
        ColorDialogButtonBuilder::default()
    }
...
impl ColorDialogButtonBuilder {
    // rustdoc-stripper-ignore-next
    /// Create a new [`ColorDialogButtonBuilder`].
    pub fn new() -> Self {
        Self::default()
    }
    ...
    pub fn build(self) -> ColorDialogButton {
        ...
        glib::Object::new::<ColorDialogButton>(&properties)
    }

    #[cfg(any(feature = "v4_10", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v4_10")))]
    pub fn dialog(mut self, dialog: &ColorDialog) -> Self {
