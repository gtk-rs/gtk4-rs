...
use crate::{
    AccessibleRole, Adjustment, Align, Buildable, ConstraintTarget, LayoutManager, ListBase,
    ListItemFactory, Orientable, Orientation, Overflow, Scrollable, ScrollablePolicy,
    SelectionModel, Widget, ffi,
};
#[cfg(feature = "v4_12")]
...
glib::wrapper! {
    #[doc(alias = "GtkGridView")]
    pub struct GridView(Object<ffi::GtkGridView, ffi::GtkGridViewClass>) @extends ListBase, Widget, @implements Buildable, ConstraintTarget, Orientable, Scrollable;
...
impl GridView {
    ...
    pub fn connect_enable_rubberband_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::enable-rubberband".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
    ...
    pub fn connect_single_click_activate_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::single-click-activate".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
