...
impl StackSwitcher {
    ...
    #[doc(alias = "stack")]
    pub fn set_stack<'a>(&self, stack: impl Into<Option<&'a Stack>>) {
        unsafe {
            ffi::gtk_stack_switcher_set_stack(self.to_glib_none().0, stack.into().to_glib_none().0);
        }
    }
...
impl StackSwitcherBuilder {
    ...
    pub fn stack<'a>(self, stack: impl Into<Option<&'a Stack>>) -> Self {
        Self {
            builder: self.builder.property("stack", stack.into()),
        }
    }
