...
glib_wrapper! {
    pub struct Window(Object<gtk_sys::GtkWindow, gtk_sys::GtkWindowClass>) @extends Widget, @implements Accessible, Buildable, ConstraintTarget, Native, Root, ShortcutManager;
